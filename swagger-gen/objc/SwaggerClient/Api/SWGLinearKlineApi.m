#import "SWGLinearKlineApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGLinearKlineApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGLinearKlineApi

NSString* kSWGLinearKlineApiErrorDomain = @"SWGLinearKlineApiErrorDomain";
NSInteger kSWGLinearKlineApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) linearKlineGetWithSymbol: (NSString*) symbol
    ...
    if (symbol == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLinearKlineApiErrorDomain code:kSWGLinearKlineApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/public/linear/kline"];
...
-(NSURLSessionTask*) linearKlineMarkPriceWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/public/linear/mark-price-kline"];
