...
-(NSURLSessionTask*) positionsMyPositionWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/position/list"];
...
-(NSURLSessionTask*) positionsUserLeverageWithCompletionHandler: 
    (void (^)(NSObject* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/user/leverage"];
