...
-(NSURLSessionTask*) marketAccountRatioWithSymbol: (NSString*) symbol
    ...
    if (period == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"period"] };
            NSError* error = [NSError errorWithDomain:kSWGMarketApiErrorDomain code:kSWGMarketApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/public/account-ratio"];
...
-(NSURLSessionTask*) marketBigDealWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/public/big-deal"];
...
-(NSURLSessionTask*) marketLiqRecordsWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/public/liq-records"];
...
-(NSURLSessionTask*) marketOpenInterestWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/public/open-interest"];
...
-(NSURLSessionTask*) marketTradingRecordsWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/public/trading-records"];
