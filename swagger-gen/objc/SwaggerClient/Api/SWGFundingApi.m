...
-(NSURLSessionTask*) fundingMyLastFeeWithSymbol: (NSString*) symbol
    ...
    if (symbol == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGFundingApiErrorDomain code:kSWGFundingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/open-api/funding/prev-funding"];
...
-(NSURLSessionTask*) fundingPredictedWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/open-api/funding/predicted-funding"];
...
-(NSURLSessionTask*) fundingPrevRateWithSymbol: (NSString*) symbol
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/open-api/funding/prev-funding-rate"];
