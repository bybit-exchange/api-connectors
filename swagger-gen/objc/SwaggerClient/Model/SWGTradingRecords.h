...
@protocol SWGTradingRecordsInfo;
@class SWGTradingRecordsInfo;



@protocol SWGTradingRecords
@end

@interface SWGTradingRecords : SWGObject
...
@property(nonatomic) NSArray<SWGTradingRecordsInfo>* result;
