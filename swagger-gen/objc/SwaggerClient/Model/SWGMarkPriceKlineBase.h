...
@class SWGMarkPriceKlineInfo;



@protocol SWGMarkPriceKlineBase
@end

@interface SWGMarkPriceKlineBase : SWGObject
...
@property(nonatomic) NSArray<SWGMarkPriceKlineInfo>* result;
