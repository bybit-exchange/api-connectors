...
func (a *OrderApiService) OrderCancel(ctx context.Context, symbol string, localVarOptionals *OrderCancelOpts) (interface{}, *http.Response, error) {
	var (
...
func (a *OrderApiService) OrderGetOrders(ctx context.Context, symbol string, localVarOptionals *OrderGetOrdersOpts) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/private/order/list"
...
func (a *OrderApiService) OrderReplace(ctx context.Context, symbol string, localVarOptionals *OrderReplaceOpts) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/private/order/replace"
