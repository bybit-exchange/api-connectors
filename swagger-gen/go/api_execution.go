...
func (a *ExecutionApiService) ExecutionGetTrades(ctx context.Context, localVarOptionals *ExecutionGetTradesOpts) (interface{}, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/v2/private/execution/list"
...
/* 
ExecutionApiService Get user&#39;s closed profit and loss records
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ExecutionApiService) PositionsClosePnlRecords(ctx context.Context, symbol string, localVarOptionals *PositionsClosePnlRecordsOpts) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
