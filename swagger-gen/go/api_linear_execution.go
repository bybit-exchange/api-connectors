...
type LinearExecutionApiService service

/* 
LinearExecutionApiService Get user&#39;s trading records.
This will get user&#39;s trading records.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LinearExecutionGetTradesOpts - Optional Parameters:
...
type LinearExecutionGetTradesOpts struct { 
...
func (a *LinearExecutionApiService) LinearExecutionGetTrades(ctx context.Context, localVarOptionals *LinearExecutionGetTradesOpts) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/private/linear/trade/execution/list"
