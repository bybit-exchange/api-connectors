//
// LinearSwitchIsolatedResult.swift
//
...
public struct LinearSwitchIsolatedResult: Codable {
    ...
    public init(retCode: Double?, retMsg: String?, extCode: String?, extInfo: String?, timeNow: String?) {
