...
#ifndef IO_SWAGGER_CLIENT_MODEL_APIKeyBase_H_
#define IO_SWAGGER_CLIENT_MODEL_APIKeyBase_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<APIKeyInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<APIKeyInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<APIKeyInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_APIKeyBase_H_ */
