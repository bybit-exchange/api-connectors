...
void FundingRateBase::validate()
{
    // TODO: implement validation
}

web::json::value FundingRateBase::toJson() const
{
...
void FundingRateBase::fromJson(web::json::value& val)
{
...
void FundingRateBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void FundingRateBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double FundingRateBase::getRetCode() const
{
    return m_Ret_code;
}


void FundingRateBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool FundingRateBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void FundingRateBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t FundingRateBase::getRetMsg() const
{
    return m_Ret_msg;
}


void FundingRateBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool FundingRateBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void FundingRateBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t FundingRateBase::getExtCode() const
{
    return m_Ext_code;
}


void FundingRateBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool FundingRateBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void FundingRateBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t FundingRateBase::getExtInfo() const
{
    return m_Ext_info;
}


void FundingRateBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool FundingRateBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void FundingRateBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> FundingRateBase::getResult() const
{
    return m_Result;
}


void FundingRateBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool FundingRateBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void FundingRateBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t FundingRateBase::getTimeNow() const
{
    return m_Time_now;
}


void FundingRateBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool FundingRateBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void FundingRateBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
