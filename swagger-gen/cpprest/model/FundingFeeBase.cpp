...
void FundingFeeBase::validate()
{
    // TODO: implement validation
}

web::json::value FundingFeeBase::toJson() const
{
...
void FundingFeeBase::fromJson(web::json::value& val)
{
...
void FundingFeeBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void FundingFeeBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double FundingFeeBase::getRetCode() const
{
    return m_Ret_code;
}


void FundingFeeBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool FundingFeeBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void FundingFeeBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t FundingFeeBase::getRetMsg() const
{
    return m_Ret_msg;
}


void FundingFeeBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool FundingFeeBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void FundingFeeBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t FundingFeeBase::getExtCode() const
{
    return m_Ext_code;
}


void FundingFeeBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool FundingFeeBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void FundingFeeBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t FundingFeeBase::getExtInfo() const
{
    return m_Ext_info;
}


void FundingFeeBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool FundingFeeBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void FundingFeeBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> FundingFeeBase::getResult() const
{
    return m_Result;
}


void FundingFeeBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool FundingFeeBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void FundingFeeBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t FundingFeeBase::getTimeNow() const
{
    return m_Time_now;
}


void FundingFeeBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool FundingFeeBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void FundingFeeBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
