...
#ifndef IO_SWAGGER_CLIENT_MODEL_OrderCancelBase_H_
#define IO_SWAGGER_CLIENT_MODEL_OrderCancelBase_H_
...
/// cancel order response
/// </summary>
class  OrderCancelBase
    : public ModelBase
{
public:
    OrderCancelBase();
    virtual ~OrderCancelBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_OrderCancelBase_H_ */
