...
#include "FundingPredictedBase.h"
...
void FundingPredictedBase::validate()
{
    // TODO: implement validation
}

web::json::value FundingPredictedBase::toJson() const
{
...
void FundingPredictedBase::fromJson(web::json::value& val)
{
...
void FundingPredictedBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void FundingPredictedBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double FundingPredictedBase::getRetCode() const
{
    return m_Ret_code;
}


void FundingPredictedBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool FundingPredictedBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void FundingPredictedBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t FundingPredictedBase::getRetMsg() const
{
    return m_Ret_msg;
}


void FundingPredictedBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool FundingPredictedBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void FundingPredictedBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t FundingPredictedBase::getExtCode() const
{
    return m_Ext_code;
}


void FundingPredictedBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool FundingPredictedBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void FundingPredictedBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t FundingPredictedBase::getExtInfo() const
{
    return m_Ext_info;
}


void FundingPredictedBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool FundingPredictedBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void FundingPredictedBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> FundingPredictedBase::getResult() const
{
    return m_Result;
}


void FundingPredictedBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool FundingPredictedBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void FundingPredictedBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t FundingPredictedBase::getTimeNow() const
{
    return m_Time_now;
}


void FundingPredictedBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool FundingPredictedBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void FundingPredictedBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
