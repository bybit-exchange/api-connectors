...
#ifndef IO_SWAGGER_CLIENT_MODEL_GetRiskLimitRes_H_
#define IO_SWAGGER_CLIENT_MODEL_GetRiskLimitRes_H_
...
/// Get risk limit.
/// </summary>
class  GetRiskLimitRes
    : public ModelBase
{
public:
    GetRiskLimitRes();
    virtual ~GetRiskLimitRes();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RiskIDRes>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<RiskIDRes>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<RiskIDRes>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_GetRiskLimitRes_H_ */
