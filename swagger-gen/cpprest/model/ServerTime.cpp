...
void ServerTime::validate()
{
    // TODO: implement validation
}

web::json::value ServerTime::toJson() const
{
...
void ServerTime::fromJson(web::json::value& val)
{
...
void ServerTime::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ServerTime::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ServerTime::getRetCode() const
{
    return m_Ret_code;
}


void ServerTime::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool ServerTime::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void ServerTime::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t ServerTime::getRetMsg() const
{
    return m_Ret_msg;
}


void ServerTime::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool ServerTime::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void ServerTime::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t ServerTime::getExtCode() const
{
    return m_Ext_code;
}


void ServerTime::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool ServerTime::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void ServerTime::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t ServerTime::getExtInfo() const
{
    return m_Ext_info;
}


void ServerTime::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool ServerTime::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void ServerTime::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> ServerTime::getResult() const
{
    return m_Result;
}


void ServerTime::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool ServerTime::resultIsSet() const
{
    return m_ResultIsSet;
}

void ServerTime::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t ServerTime::getTimeNow() const
{
    return m_Time_now;
}


void ServerTime::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool ServerTime::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void ServerTime::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
