...
#ifndef IO_SWAGGER_CLIENT_MODEL_TradingStopBase_H_
#define IO_SWAGGER_CLIENT_MODEL_TradingStopBase_H_
...
/// Set Trading-Stop Condition response
/// </summary>
class  TradingStopBase
    : public ModelBase
{
public:
    TradingStopBase();
    virtual ~TradingStopBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_TradingStopBase_H_ */
