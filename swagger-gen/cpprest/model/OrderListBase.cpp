...
void OrderListBase::validate()
{
    // TODO: implement validation
}

web::json::value OrderListBase::toJson() const
{
...
void OrderListBase::fromJson(web::json::value& val)
{
...
void OrderListBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrderListBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double OrderListBase::getRetCode() const
{
    return m_Ret_code;
}


void OrderListBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool OrderListBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void OrderListBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t OrderListBase::getRetMsg() const
{
    return m_Ret_msg;
}


void OrderListBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool OrderListBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void OrderListBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t OrderListBase::getExtCode() const
{
    return m_Ext_code;
}


void OrderListBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool OrderListBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void OrderListBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t OrderListBase::getExtInfo() const
{
    return m_Ext_info;
}


void OrderListBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool OrderListBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void OrderListBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> OrderListBase::getResult() const
{
    return m_Result;
}


void OrderListBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool OrderListBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderListBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t OrderListBase::getTimeNow() const
{
    return m_Time_now;
}


void OrderListBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool OrderListBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void OrderListBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
