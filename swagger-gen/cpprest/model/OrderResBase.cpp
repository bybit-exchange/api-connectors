...
void OrderResBase::validate()
{
    // TODO: implement validation
}

web::json::value OrderResBase::toJson() const
{
...
void OrderResBase::fromJson(web::json::value& val)
{
...
void OrderResBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrderResBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double OrderResBase::getRetCode() const
{
    return m_Ret_code;
}


void OrderResBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool OrderResBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void OrderResBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t OrderResBase::getRetMsg() const
{
    return m_Ret_msg;
}


void OrderResBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool OrderResBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void OrderResBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t OrderResBase::getExtCode() const
{
    return m_Ext_code;
}


void OrderResBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool OrderResBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void OrderResBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t OrderResBase::getExtInfo() const
{
    return m_Ext_info;
}


void OrderResBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool OrderResBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void OrderResBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> OrderResBase::getResult() const
{
    return m_Result;
}


void OrderResBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool OrderResBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderResBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t OrderResBase::getTimeNow() const
{
    return m_Time_now;
}


void OrderResBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool OrderResBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void OrderResBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
