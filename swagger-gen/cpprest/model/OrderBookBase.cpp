...
void OrderBookBase::validate()
{
    // TODO: implement validation
}

web::json::value OrderBookBase::toJson() const
{
...
void OrderBookBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<OderBookRes>(nullptr) );
            }
            else
            {
                std::shared_ptr<OderBookRes> newItem(new OderBookRes());
...
void OrderBookBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrderBookBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double OrderBookBase::getRetCode() const
{
    return m_Ret_code;
}


void OrderBookBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool OrderBookBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void OrderBookBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t OrderBookBase::getRetMsg() const
{
    return m_Ret_msg;
}


void OrderBookBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool OrderBookBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void OrderBookBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t OrderBookBase::getExtCode() const
{
    return m_Ext_code;
}


void OrderBookBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool OrderBookBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void OrderBookBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t OrderBookBase::getExtInfo() const
{
    return m_Ext_info;
}


void OrderBookBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool OrderBookBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void OrderBookBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<OderBookRes>>& OrderBookBase::getResult()
{
    return m_Result;
}

void OrderBookBase::setResult(std::vector<std::shared_ptr<OderBookRes>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool OrderBookBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderBookBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t OrderBookBase::getTimeNow() const
{
    return m_Time_now;
}


void OrderBookBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool OrderBookBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void OrderBookBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
