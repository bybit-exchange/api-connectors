...
void KlineBase::validate()
{
    // TODO: implement validation
}

web::json::value KlineBase::toJson() const
{
...
void KlineBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<KlineRes>(nullptr) );
            }
            else
            {
                std::shared_ptr<KlineRes> newItem(new KlineRes());
...
void KlineBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void KlineBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double KlineBase::getRetCode() const
{
    return m_Ret_code;
}


void KlineBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool KlineBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void KlineBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t KlineBase::getRetMsg() const
{
    return m_Ret_msg;
}


void KlineBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool KlineBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void KlineBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t KlineBase::getExtCode() const
{
    return m_Ext_code;
}


void KlineBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool KlineBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void KlineBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t KlineBase::getExtInfo() const
{
    return m_Ext_info;
}


void KlineBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool KlineBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void KlineBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<KlineRes>>& KlineBase::getResult()
{
    return m_Result;
}

void KlineBase::setResult(std::vector<std::shared_ptr<KlineRes>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool KlineBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void KlineBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t KlineBase::getTimeNow() const
{
    return m_Time_now;
}


void KlineBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool KlineBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void KlineBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
