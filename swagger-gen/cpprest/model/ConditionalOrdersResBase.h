...
/*
 * ConditionalOrdersResBase.h
 *
 * Get conditional order list
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_ConditionalOrdersResBase_H_
#define IO_SWAGGER_CLIENT_MODEL_ConditionalOrdersResBase_H_
...
/// Get conditional order list
/// </summary>
class  ConditionalOrdersResBase
    : public ModelBase
{
public:
    ConditionalOrdersResBase();
    virtual ~ConditionalOrdersResBase();
    ...
    /////////////////////////////////////////////
    /// ConditionalOrdersResBase members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ConditionalOrdersRes>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<ConditionalOrdersRes>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<ConditionalOrdersRes>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_ConditionalOrdersResBase_H_ */
