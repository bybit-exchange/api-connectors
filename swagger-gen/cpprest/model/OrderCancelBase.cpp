...
void OrderCancelBase::validate()
{
    // TODO: implement validation
}

web::json::value OrderCancelBase::toJson() const
{
...
void OrderCancelBase::fromJson(web::json::value& val)
{
...
void OrderCancelBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OrderCancelBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double OrderCancelBase::getRetCode() const
{
    return m_Ret_code;
}


void OrderCancelBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool OrderCancelBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void OrderCancelBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t OrderCancelBase::getRetMsg() const
{
    return m_Ret_msg;
}


void OrderCancelBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool OrderCancelBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void OrderCancelBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t OrderCancelBase::getExtCode() const
{
    return m_Ext_code;
}


void OrderCancelBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool OrderCancelBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void OrderCancelBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t OrderCancelBase::getExtInfo() const
{
    return m_Ext_info;
}


void OrderCancelBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool OrderCancelBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void OrderCancelBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> OrderCancelBase::getResult() const
{
    return m_Result;
}


void OrderCancelBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool OrderCancelBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void OrderCancelBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t OrderCancelBase::getTimeNow() const
{
    return m_Time_now;
}


void OrderCancelBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool OrderCancelBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void OrderCancelBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
