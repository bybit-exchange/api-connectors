...
/*
 * OrderCancelAllBase.h
 *
 * Cancel all active orders response
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_OrderCancelAllBase_H_
#define IO_SWAGGER_CLIENT_MODEL_OrderCancelAllBase_H_
...
/// Cancel all active orders response
/// </summary>
class  OrderCancelAllBase
    : public ModelBase
{
public:
    OrderCancelAllBase();
    virtual ~OrderCancelAllBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_OrderCancelAllBase_H_ */
