...
#ifndef IO_SWAGGER_CLIENT_MODEL_QueryOrderBase_H_
#define IO_SWAGGER_CLIENT_MODEL_QueryOrderBase_H_
...
/// Query real-time active order information response
/// </summary>
class  QueryOrderBase
    : public ModelBase
{
public:
    QueryOrderBase();
    virtual ~QueryOrderBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_QueryOrderBase_H_ */
