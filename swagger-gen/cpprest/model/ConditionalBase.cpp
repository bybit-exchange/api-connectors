...
void ConditionalBase::validate()
{
    // TODO: implement validation
}

web::json::value ConditionalBase::toJson() const
{
...
void ConditionalBase::fromJson(web::json::value& val)
{
...
void ConditionalBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ConditionalBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ConditionalBase::getRetCode() const
{
    return m_Ret_code;
}


void ConditionalBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool ConditionalBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void ConditionalBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t ConditionalBase::getRetMsg() const
{
    return m_Ret_msg;
}


void ConditionalBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool ConditionalBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void ConditionalBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t ConditionalBase::getExtCode() const
{
    return m_Ext_code;
}


void ConditionalBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool ConditionalBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void ConditionalBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t ConditionalBase::getExtInfo() const
{
    return m_Ext_info;
}


void ConditionalBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool ConditionalBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void ConditionalBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> ConditionalBase::getResult() const
{
    return m_Result;
}


void ConditionalBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool ConditionalBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void ConditionalBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t ConditionalBase::getTimeNow() const
{
    return m_Time_now;
}


void ConditionalBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool ConditionalBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void ConditionalBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
