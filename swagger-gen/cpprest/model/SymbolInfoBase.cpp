...
void SymbolInfoBase::validate()
{
    // TODO: implement validation
}

web::json::value SymbolInfoBase::toJson() const
{
...
void SymbolInfoBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<SymbolTickInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<SymbolTickInfo> newItem(new SymbolTickInfo());
...
void SymbolInfoBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SymbolInfoBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double SymbolInfoBase::getRetCode() const
{
    return m_Ret_code;
}


void SymbolInfoBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool SymbolInfoBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void SymbolInfoBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t SymbolInfoBase::getRetMsg() const
{
    return m_Ret_msg;
}


void SymbolInfoBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool SymbolInfoBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void SymbolInfoBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t SymbolInfoBase::getExtCode() const
{
    return m_Ext_code;
}


void SymbolInfoBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool SymbolInfoBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void SymbolInfoBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t SymbolInfoBase::getExtInfo() const
{
    return m_Ext_info;
}


void SymbolInfoBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool SymbolInfoBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void SymbolInfoBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<SymbolTickInfo>>& SymbolInfoBase::getResult()
{
    return m_Result;
}

void SymbolInfoBase::setResult(std::vector<std::shared_ptr<SymbolTickInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool SymbolInfoBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void SymbolInfoBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t SymbolInfoBase::getTimeNow() const
{
    return m_Time_now;
}


void SymbolInfoBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool SymbolInfoBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void SymbolInfoBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
