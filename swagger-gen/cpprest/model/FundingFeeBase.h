...
#ifndef IO_SWAGGER_CLIENT_MODEL_FundingFeeBase_H_
#define IO_SWAGGER_CLIENT_MODEL_FundingFeeBase_H_
...
/// Get the last funding fee
/// </summary>
class  FundingFeeBase
    : public ModelBase
{
public:
    FundingFeeBase();
    virtual ~FundingFeeBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_FundingFeeBase_H_ */
