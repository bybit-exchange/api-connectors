...
------------- | ------------- | -------------
[**futuresExecutionGetTrades**](FuturesExecutionApi.md#futuresExecutionGetTrades) | **GET** /futures/private/execution/list | Get user’s trade records.
[**futuresPositionsClosePnlRecords**](FuturesExecutionApi.md#futuresPositionsClosePnlRecords) | **GET** /futures/private/trade/closed-pnl/list | Get user&#39;s closed profit and loss records


<a name="futuresExecutionGetTrades"></a>
# **futuresExecutionGetTrades**
> Object futuresExecutionGetTrades(symbol, orderId, startTime, page, limit)
...
//import io.swagger.client.api.FuturesExecutionApi;
...
FuturesExecutionApi apiInstance = new FuturesExecutionApi();
...
try {
    Object result = apiInstance.futuresExecutionGetTrades(symbol, orderId, startTime, page, limit);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling FuturesExecutionApi#futuresExecutionGetTrades");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling FuturesExecutionApi#futuresPositionsClosePnlRecords");
    e.printStackTrace();
}
```
