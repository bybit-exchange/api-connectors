...
public class ApiClient {
    ...
    private String basePath = "https://api.bybit.com";
    ...
    public ApiClient() {
        ...
        setUserAgent("Bybit-Swagger-Codegen/0.2.12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.bybit.com
            ...
            if (method.equals("GET") || method.equals("POST")) {
                ...
                if (method.equals("GET")) {
                    ...
                    if (null != formParams && !formParams.isEmpty()) {
                        ...
                        for (Entry entry : formParams.entrySet()) {
                            map.put(entry.getKey().toString(), entry.getValue());
                            jsonParams.add(entry.getKey().toString(), gson.toJsonTree(entry.getValue().toString()));
                        }
                    }
                }
                ...
                if (method.equals("GET")) {
                    ...
                    jsonParams.add("api_key", new JsonPrimitive(this.getApiKey()));
                    jsonParams.add("timestamp", new JsonPrimitive(timestamp));
                    jsonParams.add("sign", new JsonPrimitive(signature));
                    reqBody = serialize(jsonParams, "application/json");
                    ;
                }
            }
        }
...
//        }
    ...
    private String getSignature(TreeMap<String, String> params, String secret) throws InvalidKeyException, NoSuchAlgorithmException {
        Set<String> keySet = params.keySet();
        Iterator<String> iter = keySet.iterator();
        StringBuilder sb = new StringBuilder();
        while (iter.hasNext()) {
            String key = iter.next();
            //此处需要把 params.get(key)的值转换成String类型
