...
public class ExecutionApi {
     ...
     */
    public com.squareup.okhttp.Call executionGetTradesCall(String symbol, String orderId, String startTime, String page, String limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v2/private/execution/list";
    ...
    private com.squareup.okhttp.Call executionGetTradesValidateBeforeCall(String symbol, String orderId, String startTime, String page, String limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'symbol' is set
        if (symbol == null) {
            throw new ApiException("Missing the required parameter 'symbol' when calling executionGetTrades(Async)");
        }
        

        com.squareup.okhttp.Call call = executionGetTradesCall(symbol, orderId, startTime, page, limit, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Object executionGetTrades(String symbol, String orderId, String startTime, String page, String limit) throws ApiException {
        ApiResponse<Object> resp = executionGetTradesWithHttpInfo(symbol, orderId, startTime, page, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> executionGetTradesWithHttpInfo(String symbol, String orderId, String startTime, String page, String limit) throws ApiException {
        com.squareup.okhttp.Call call = executionGetTradesValidateBeforeCall(symbol, orderId, startTime, page, limit, null, null);
     ...
     */
    public com.squareup.okhttp.Call executionGetTradesAsync(String symbol, String orderId, String startTime, String page, String limit, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = executionGetTradesValidateBeforeCall(symbol, orderId, startTime, page, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
