...
public class LinearOrderApi {
    ...
    private com.squareup.okhttp.Call linearOrderNewValidateBeforeCall(String symbol, String side, String orderType, String timeInForce, Double qty, Double price, Double takeProfit, Double stopLoss, Boolean reduceOnly, String tpTriggerBy, String slTriggerBy, Boolean closeOnTrigger, String orderLinkId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'takeProfit' is set
//        if (takeProfit == null) {
//            throw new ApiException("Missing the required parameter 'takeProfit' when calling orderNew(Async)");
//        }

        // verify the required parameter 'stopLoss' is set
//        if (stopLoss == null) {
//            throw new ApiException("Missing the required parameter 'stopLoss' when calling orderNew(Async)");
//        }

        // verify the required parameter 'reduceOnly' is set
        if (reduceOnly == null) {
            throw new ApiException("Missing the required parameter 'reduceOnly' when calling orderNew(Async)");
        }

        // verify the required parameter 'closeOnTrigger' is set
        if (closeOnTrigger == null) {
            throw new ApiException("Missing the required parameter 'closeOnTrigger' when calling orderNew(Async)");
        }
