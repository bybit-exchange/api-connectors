...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearStopOrderRecordsResponseBase :  IEquatable<LinearStopOrderRecordsResponseBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearStopOrderRecordsResponseBase" /> class.
        /// </summary>
        ...
        public LinearStopOrderRecordsResponseBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearStopOrderRecordsResponseBase);
        }

        /// <summary>
        /// Returns true if LinearStopOrderRecordsResponseBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearStopOrderRecordsResponseBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearStopOrderRecordsResponseBase input)
        {
            if (input == null)
                return false;
