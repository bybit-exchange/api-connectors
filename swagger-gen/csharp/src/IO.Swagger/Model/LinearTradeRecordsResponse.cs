...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearTradeRecordsResponse :  IEquatable<LinearTradeRecordsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearTradeRecordsResponse" /> class.
        /// </summary>
        ...
        public LinearTradeRecordsResponse(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<LinearTradeRecordItem> result = default(List<LinearTradeRecordItem>), string timeNow = default(string))
        {
        ...
        public List<LinearTradeRecordItem> Result { get; set; }
        ...
        {
            return this.Equals(input as LinearTradeRecordsResponse);
        }

        /// <summary>
        /// Returns true if LinearTradeRecordsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearTradeRecordsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearTradeRecordsResponse input)
        {
            if (input == null)
                return false;
