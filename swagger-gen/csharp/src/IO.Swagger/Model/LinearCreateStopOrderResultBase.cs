...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearCreateStopOrderResultBase :  IEquatable<LinearCreateStopOrderResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearCreateStopOrderResultBase" /> class.
        /// </summary>
        ...
        public LinearCreateStopOrderResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearCreateStopOrderResultBase);
        }

        /// <summary>
        /// Returns true if LinearCreateStopOrderResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearCreateStopOrderResultBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearCreateStopOrderResultBase input)
        {
            if (input == null)
                return false;
