...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FundingPredictedBase :  IEquatable<FundingPredictedBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingPredictedBase" /> class.
        /// </summary>
        ...
        public FundingPredictedBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as FundingPredictedBase);
        }

        /// <summary>
        /// Returns true if FundingPredictedBase instances are equal
        /// </summary>
        /// <param name="input">Instance of FundingPredictedBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundingPredictedBase input)
        {
            if (input == null)
                return false;
