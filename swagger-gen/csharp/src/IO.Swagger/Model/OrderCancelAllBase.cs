...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderCancelAllBase :  IEquatable<OrderCancelAllBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCancelAllBase" /> class.
        /// </summary>
        ...
        public OrderCancelAllBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as OrderCancelAllBase);
        }

        /// <summary>
        /// Returns true if OrderCancelAllBase instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderCancelAllBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderCancelAllBase input)
        {
            if (input == null)
                return false;
