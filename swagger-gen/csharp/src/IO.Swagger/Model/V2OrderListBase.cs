...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2OrderListBase :  IEquatable<V2OrderListBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2OrderListBase" /> class.
        /// </summary>
        ...
        public V2OrderListBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as V2OrderListBase);
        }

        /// <summary>
        /// Returns true if V2OrderListBase instances are equal
        /// </summary>
        /// <param name="input">Instance of V2OrderListBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2OrderListBase input)
        {
            if (input == null)
                return false;
