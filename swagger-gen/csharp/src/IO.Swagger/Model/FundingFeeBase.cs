...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FundingFeeBase :  IEquatable<FundingFeeBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingFeeBase" /> class.
        /// </summary>
        ...
        public FundingFeeBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as FundingFeeBase);
        }

        /// <summary>
        /// Returns true if FundingFeeBase instances are equal
        /// </summary>
        /// <param name="input">Instance of FundingFeeBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundingFeeBase input)
        {
            if (input == null)
                return false;
