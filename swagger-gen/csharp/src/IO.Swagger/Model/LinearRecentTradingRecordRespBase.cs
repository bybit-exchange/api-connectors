...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearRecentTradingRecordRespBase :  IEquatable<LinearRecentTradingRecordRespBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearRecentTradingRecordRespBase" /> class.
        /// </summary>
        ...
        public LinearRecentTradingRecordRespBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearRecentTradingRecordRespBase);
        }

        /// <summary>
        /// Returns true if LinearRecentTradingRecordRespBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearRecentTradingRecordRespBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearRecentTradingRecordRespBase input)
        {
            if (input == null)
                return false;
