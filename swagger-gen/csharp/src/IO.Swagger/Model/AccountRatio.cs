...
namespace IO.Swagger.Model
{
    ...
    public partial class AccountRatio :  IEquatable<AccountRatio>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AccountRatio);
        }

        /// <summary>
        /// Returns true if AccountRatio instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountRatio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountRatio input)
        {
            if (input == null)
                return false;
