...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RiskLimitBase :  IEquatable<RiskLimitBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskLimitBase" /> class.
        /// </summary>
        ...
        public RiskLimitBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as RiskLimitBase);
        }

        /// <summary>
        /// Returns true if RiskLimitBase instances are equal
        /// </summary>
        /// <param name="input">Instance of RiskLimitBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RiskLimitBase input)
        {
            if (input == null)
                return false;
