...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionalOrdersResBase :  IEquatable<ConditionalOrdersResBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionalOrdersResBase" /> class.
        /// </summary>
        ...
        public ConditionalOrdersResBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<ConditionalOrdersRes> result = default(List<ConditionalOrdersRes>), string timeNow = default(string))
        {
        ...
        public List<ConditionalOrdersRes> Result { get; set; }
        ...
        {
            return this.Equals(input as ConditionalOrdersResBase);
        }

        /// <summary>
        /// Returns true if ConditionalOrdersResBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionalOrdersResBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionalOrdersResBase input)
        {
            if (input == null)
                return false;
