...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionalBase :  IEquatable<ConditionalBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionalBase" /> class.
        /// </summary>
        ...
        public ConditionalBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as ConditionalBase);
        }

        /// <summary>
        /// Returns true if ConditionalBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionalBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionalBase input)
        {
            if (input == null)
                return false;
