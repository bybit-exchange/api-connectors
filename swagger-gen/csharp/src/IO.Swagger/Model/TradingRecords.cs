...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradingRecords :  IEquatable<TradingRecords>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradingRecords" /> class.
        /// </summary>
        ...
        public TradingRecords(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<TradingRecordsInfo> result = default(List<TradingRecordsInfo>), string timeNow = default(string))
        {
        ...
        public List<TradingRecordsInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as TradingRecords);
        }

        /// <summary>
        /// Returns true if TradingRecords instances are equal
        /// </summary>
        /// <param name="input">Instance of TradingRecords to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradingRecords input)
        {
            if (input == null)
                return false;
