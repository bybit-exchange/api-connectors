...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QueryOrderBase :  IEquatable<QueryOrderBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryOrderBase" /> class.
        /// </summary>
        ...
        public QueryOrderBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as QueryOrderBase);
        }

        /// <summary>
        /// Returns true if QueryOrderBase instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryOrderBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryOrderBase input)
        {
            if (input == null)
                return false;
