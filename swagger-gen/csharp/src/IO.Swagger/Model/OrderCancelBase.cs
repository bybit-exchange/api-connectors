...
namespace IO.Swagger.Model
{
    ...
    public partial class OrderCancelBase :  IEquatable<OrderCancelBase>, IValidatableObject
    {
        ...
        public OrderCancelBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as OrderCancelBase);
        }
