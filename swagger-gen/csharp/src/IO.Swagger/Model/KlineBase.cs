...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KlineBase :  IEquatable<KlineBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KlineBase" /> class.
        /// </summary>
        ...
        public KlineBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<KlineRes> result = default(List<KlineRes>), string timeNow = default(string))
        {
        ...
        public List<KlineRes> Result { get; set; }
        ...
        {
            return this.Equals(input as KlineBase);
        }

        /// <summary>
        /// Returns true if KlineBase instances are equal
        /// </summary>
        /// <param name="input">Instance of KlineBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KlineBase input)
        {
            if (input == null)
                return false;
