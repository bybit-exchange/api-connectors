...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearCancelStopOrderResultBase :  IEquatable<LinearCancelStopOrderResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearCancelStopOrderResultBase" /> class.
        /// </summary>
        ...
        public LinearCancelStopOrderResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearCancelStopOrderResultBase);
        }

        /// <summary>
        /// Returns true if LinearCancelStopOrderResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearCancelStopOrderResultBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearCancelStopOrderResultBase input)
        {
            if (input == null)
                return false;
