...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearOrderRecordsResponseBase :  IEquatable<LinearOrderRecordsResponseBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearOrderRecordsResponseBase" /> class.
        /// </summary>
        ...
        public LinearOrderRecordsResponseBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearOrderRecordsResponseBase);
        }

        /// <summary>
        /// Returns true if LinearOrderRecordsResponseBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearOrderRecordsResponseBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearOrderRecordsResponseBase input)
        {
            if (input == null)
                return false;
