...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetRiskLimitRes :  IEquatable<GetRiskLimitRes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRiskLimitRes" /> class.
        /// </summary>
        ...
        public GetRiskLimitRes(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<RiskIDRes> result = default(List<RiskIDRes>), string timeNow = default(string))
        {
        ...
        public List<RiskIDRes> Result { get; set; }
        ...
        {
            return this.Equals(input as GetRiskLimitRes);
        }

        /// <summary>
        /// Returns true if GetRiskLimitRes instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRiskLimitRes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRiskLimitRes input)
        {
            if (input == null)
                return false;
