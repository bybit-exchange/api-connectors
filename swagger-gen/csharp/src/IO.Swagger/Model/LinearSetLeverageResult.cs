...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearSetLeverageResult :  IEquatable<LinearSetLeverageResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearSetLeverageResult" /> class.
        /// </summary>
        ...
        public LinearSetLeverageResult(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearSetLeverageResult);
        }

        /// <summary>
        /// Returns true if LinearSetLeverageResult instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearSetLeverageResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearSetLeverageResult input)
        {
            if (input == null)
                return false;
