...
namespace IO.Swagger.Model
{
    ...
    public partial class ReplaceConditionalBase :  IEquatable<ReplaceConditionalBase>, IValidatableObject
    {
        ...
        public ReplaceConditionalBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), string result = default(string), string timeNow = default(string))
        {
