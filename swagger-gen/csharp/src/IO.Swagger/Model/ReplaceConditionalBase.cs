...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplaceConditionalBase :  IEquatable<ReplaceConditionalBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceConditionalBase" /> class.
        /// </summary>
        ...
        public ReplaceConditionalBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as ReplaceConditionalBase);
        }

        /// <summary>
        /// Returns true if ReplaceConditionalBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceConditionalBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceConditionalBase input)
        {
            if (input == null)
                return false;
