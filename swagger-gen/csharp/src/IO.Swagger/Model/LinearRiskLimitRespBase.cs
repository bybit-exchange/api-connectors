...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearRiskLimitRespBase :  IEquatable<LinearRiskLimitRespBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearRiskLimitRespBase" /> class.
        /// </summary>
        ...
        public LinearRiskLimitRespBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearRiskLimitRespBase);
        }

        /// <summary>
        /// Returns true if LinearRiskLimitRespBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearRiskLimitRespBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearRiskLimitRespBase input)
        {
            if (input == null)
                return false;
