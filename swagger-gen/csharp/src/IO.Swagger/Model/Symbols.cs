...
namespace IO.Swagger.Model
{
    ...
    public partial class Symbols :  IEquatable<Symbols>, IValidatableObject
    {
        ...
        public Symbols(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<SymbolInfo> result = default(List<SymbolInfo>), string timeNow = default(string))
        {
        ...
        public List<SymbolInfo> Result { get; set; }
