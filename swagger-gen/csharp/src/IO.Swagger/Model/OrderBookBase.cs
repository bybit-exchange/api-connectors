...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderBookBase :  IEquatable<OrderBookBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderBookBase" /> class.
        /// </summary>
        ...
        public OrderBookBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<OderBookRes> result = default(List<OderBookRes>), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as OrderBookBase);
        }

        /// <summary>
        /// Returns true if OrderBookBase instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderBookBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderBookBase input)
        {
            if (input == null)
                return false;
