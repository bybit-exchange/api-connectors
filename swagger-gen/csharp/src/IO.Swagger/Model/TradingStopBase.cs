...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradingStopBase :  IEquatable<TradingStopBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradingStopBase" /> class.
        /// </summary>
        ...
        public TradingStopBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as TradingStopBase);
        }

        /// <summary>
        /// Returns true if TradingStopBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TradingStopBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradingStopBase input)
        {
            if (input == null)
                return false;
