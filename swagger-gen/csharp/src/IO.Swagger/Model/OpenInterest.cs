...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpenInterest :  IEquatable<OpenInterest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenInterest" /> class.
        /// </summary>
        ...
        public OpenInterest(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<OpenInterestInfo> result = default(List<OpenInterestInfo>), string timeNow = default(string))
        {
        ...
        public List<OpenInterestInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as OpenInterest);
        }

        /// <summary>
        /// Returns true if OpenInterest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenInterest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenInterest input)
        {
            if (input == null)
                return false;
