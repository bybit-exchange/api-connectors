...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BigDeal :  IEquatable<BigDeal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BigDeal" /> class.
        /// </summary>
        ...
        public BigDeal(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<BigDealInfo> result = default(List<BigDealInfo>), string timeNow = default(string))
        {
        ...
        public List<BigDealInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as BigDeal);
        }

        /// <summary>
        /// Returns true if BigDeal instances are equal
        /// </summary>
        /// <param name="input">Instance of BigDeal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BigDeal input)
        {
            if (input == null)
                return false;
