...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearOrderReplace :  IEquatable<LinearOrderReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearOrderReplace" /> class.
        /// </summary>
        ...
        public LinearOrderReplace(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearOrderReplace);
        }

        /// <summary>
        /// Returns true if LinearOrderReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearOrderReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearOrderReplace input)
        {
            if (input == null)
                return false;
