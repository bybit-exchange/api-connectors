...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearSearchStopOrderResultBase :  IEquatable<LinearSearchStopOrderResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearSearchStopOrderResultBase" /> class.
        /// </summary>
        ...
        public LinearSearchStopOrderResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearSearchStopOrderResultBase);
        }

        /// <summary>
        /// Returns true if LinearSearchStopOrderResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearSearchStopOrderResultBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearSearchStopOrderResultBase input)
        {
            if (input == null)
                return false;
