...
namespace IO.Swagger.Model
{
    ...
    public partial class FundRecordBase :  IEquatable<FundRecordBase>, IValidatableObject
    {
        ...
        public FundRecordBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<FundingRecords> result = default(List<FundingRecords>), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as FundRecordBase);
        }
