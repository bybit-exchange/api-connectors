...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearKlineRespBase :  IEquatable<LinearKlineRespBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearKlineRespBase" /> class.
        /// </summary>
        ...
        public LinearKlineRespBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearKlineRespBase);
        }

        /// <summary>
        /// Returns true if LinearKlineRespBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearKlineRespBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearKlineRespBase input)
        {
            if (input == null)
                return false;
