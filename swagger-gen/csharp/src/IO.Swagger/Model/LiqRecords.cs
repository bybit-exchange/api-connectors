...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LiqRecords :  IEquatable<LiqRecords>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiqRecords" /> class.
        /// </summary>
        ...
        public LiqRecords(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<LiqRecordsInfo> result = default(List<LiqRecordsInfo>), string timeNow = default(string))
        {
        ...
        public List<LiqRecordsInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as LiqRecords);
        }

        /// <summary>
        /// Returns true if LiqRecords instances are equal
        /// </summary>
        /// <param name="input">Instance of LiqRecords to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LiqRecords input)
        {
            if (input == null)
                return false;
