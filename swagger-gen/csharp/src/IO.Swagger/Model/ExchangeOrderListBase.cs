...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExchangeOrderListBase :  IEquatable<ExchangeOrderListBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeOrderListBase" /> class.
        /// </summary>
        ...
        public ExchangeOrderListBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<ExchangeOrderList> result = default(List<ExchangeOrderList>), string timeNow = default(string))
        {
        ...
        public List<ExchangeOrderList> Result { get; set; }
        ...
        {
            return this.Equals(input as ExchangeOrderListBase);
        }

        /// <summary>
        /// Returns true if ExchangeOrderListBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeOrderListBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeOrderListBase input)
        {
            if (input == null)
                return false;
