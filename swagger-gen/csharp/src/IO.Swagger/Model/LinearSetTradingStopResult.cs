...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearSetTradingStopResult :  IEquatable<LinearSetTradingStopResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearSetTradingStopResult" /> class.
        /// </summary>
        ...
        public LinearSetTradingStopResult(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearSetTradingStopResult);
        }

        /// <summary>
        /// Returns true if LinearSetTradingStopResult instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearSetTradingStopResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearSetTradingStopResult input)
        {
            if (input == null)
                return false;
