...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WithdrawBalance :  IEquatable<WithdrawBalance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WithdrawBalance" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as WithdrawBalance);
        }

        /// <summary>
        /// Returns true if WithdrawBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of WithdrawBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WithdrawBalance input)
        {
            if (input == null)
                return false;
