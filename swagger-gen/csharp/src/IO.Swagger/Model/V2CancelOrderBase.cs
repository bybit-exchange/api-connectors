...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2CancelOrderBase :  IEquatable<V2CancelOrderBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2CancelOrderBase" /> class.
        /// </summary>
        ...
        public V2CancelOrderBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as V2CancelOrderBase);
        }

        /// <summary>
        /// Returns true if V2CancelOrderBase instances are equal
        /// </summary>
        /// <param name="input">Instance of V2CancelOrderBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2CancelOrderBase input)
        {
            if (input == null)
                return false;
