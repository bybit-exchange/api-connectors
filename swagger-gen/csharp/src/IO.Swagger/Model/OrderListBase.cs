...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderListBase :  IEquatable<OrderListBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderListBase" /> class.
        /// </summary>
        ...
        public OrderListBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as OrderListBase);
        }

        /// <summary>
        /// Returns true if OrderListBase instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderListBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderListBase input)
        {
            if (input == null)
                return false;
