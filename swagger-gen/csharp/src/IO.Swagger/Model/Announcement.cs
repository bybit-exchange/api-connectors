...
namespace IO.Swagger.Model
{
    ...
    public partial class Announcement :  IEquatable<Announcement>, IValidatableObject
    {
        ...
        public Announcement(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<AnnouncementInfo> result = default(List<AnnouncementInfo>), string timeNow = default(string))
        {
        ...
        public List<AnnouncementInfo> Result { get; set; }
