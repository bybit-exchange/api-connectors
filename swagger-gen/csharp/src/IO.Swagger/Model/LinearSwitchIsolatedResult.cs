...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearSwitchIsolatedResult :  IEquatable<LinearSwitchIsolatedResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearSwitchIsolatedResult" /> class.
        /// </summary>
        ...
        public LinearSwitchIsolatedResult(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearSwitchIsolatedResult);
        }

        /// <summary>
        /// Returns true if LinearSwitchIsolatedResult instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearSwitchIsolatedResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearSwitchIsolatedResult input)
        {
            if (input == null)
                return false;
