...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WithdrawBalanceBase :  IEquatable<WithdrawBalanceBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WithdrawBalanceBase" /> class.
        /// </summary>
        ...
        public WithdrawBalanceBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as WithdrawBalanceBase);
        }

        /// <summary>
        /// Returns true if WithdrawBalanceBase instances are equal
        /// </summary>
        /// <param name="input">Instance of WithdrawBalanceBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WithdrawBalanceBase input)
        {
            if (input == null)
                return false;
