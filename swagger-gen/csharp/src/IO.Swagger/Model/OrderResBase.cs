...
namespace IO.Swagger.Model
{
    ...
    public partial class OrderResBase :  IEquatable<OrderResBase>, IValidatableObject
    {
        ...
        public OrderResBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
