...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearPrevFundingRateRespBase :  IEquatable<LinearPrevFundingRateRespBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearPrevFundingRateRespBase" /> class.
        /// </summary>
        ...
        public LinearPrevFundingRateRespBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearPrevFundingRateRespBase);
        }

        /// <summary>
        /// Returns true if LinearPrevFundingRateRespBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearPrevFundingRateRespBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearPrevFundingRateRespBase input)
        {
            if (input == null)
                return false;
