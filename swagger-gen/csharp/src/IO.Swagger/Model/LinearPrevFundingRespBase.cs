...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearPrevFundingRespBase :  IEquatable<LinearPrevFundingRespBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearPrevFundingRespBase" /> class.
        /// </summary>
        ...
        public LinearPrevFundingRespBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearPrevFundingRespBase);
        }

        /// <summary>
        /// Returns true if LinearPrevFundingRespBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearPrevFundingRespBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearPrevFundingRespBase input)
        {
            if (input == null)
                return false;
