...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearSetMarginResultBase :  IEquatable<LinearSetMarginResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearSetMarginResultBase" /> class.
        /// </summary>
        ...
        public LinearSetMarginResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearSetMarginResultBase);
        }

        /// <summary>
        /// Returns true if LinearSetMarginResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearSetMarginResultBase to be compared</param>
        /// <returns>Boolean</returns>
