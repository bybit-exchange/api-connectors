...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetRiskLimitBase :  IEquatable<SetRiskLimitBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetRiskLimitBase" /> class.
        /// </summary>
        ...
        public SetRiskLimitBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as SetRiskLimitBase);
        }

        /// <summary>
        /// Returns true if SetRiskLimitBase instances are equal
        /// </summary>
        /// <param name="input">Instance of SetRiskLimitBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetRiskLimitBase input)
        {
            if (input == null)
                return false;
