...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClosedPnlBase :  IEquatable<ClosedPnlBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClosedPnlBase" /> class.
        /// </summary>
        ...
        public ClosedPnlBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<ClosedPnlInfo> result = default(List<ClosedPnlInfo>), string timeNow = default(string))
        {
        ...
        public List<ClosedPnlInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as ClosedPnlBase);
        }

        /// <summary>
        /// Returns true if ClosedPnlBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ClosedPnlBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClosedPnlBase input)
        {
            if (input == null)
                return false;
