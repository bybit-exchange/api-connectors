...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReplaceOrderBase :  IEquatable<ReplaceOrderBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceOrderBase" /> class.
        /// </summary>
        ...
        public ReplaceOrderBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as ReplaceOrderBase);
        }

        /// <summary>
        /// Returns true if ReplaceOrderBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceOrderBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceOrderBase input)
        {
            if (input == null)
                return false;
