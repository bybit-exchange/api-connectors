...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearFundingPredictedBase :  IEquatable<LinearFundingPredictedBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearFundingPredictedBase" /> class.
        /// </summary>
        ...
        public LinearFundingPredictedBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearFundingPredictedBase);
        }

        /// <summary>
        /// Returns true if LinearFundingPredictedBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearFundingPredictedBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearFundingPredictedBase input)
        {
            if (input == null)
                return false;
