...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WithdrawResBase :  IEquatable<WithdrawResBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WithdrawResBase" /> class.
        /// </summary>
        ...
        public WithdrawResBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<WithdrawRecords> result = default(List<WithdrawRecords>), string timeNow = default(string))
        {
        ...
        public List<WithdrawRecords> Result { get; set; }
        ...
        {
            return this.Equals(input as WithdrawResBase);
        }

        /// <summary>
        /// Returns true if WithdrawResBase instances are equal
        /// </summary>
        /// <param name="input">Instance of WithdrawResBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WithdrawResBase input)
        {
            if (input == null)
                return false;
