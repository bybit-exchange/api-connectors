...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearStopOrderCancelAllBase :  IEquatable<LinearStopOrderCancelAllBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearStopOrderCancelAllBase" /> class.
        /// </summary>
        ...
        public LinearStopOrderCancelAllBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<string> result = default(List<string>), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearStopOrderCancelAllBase);
        }

        /// <summary>
        /// Returns true if LinearStopOrderCancelAllBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearStopOrderCancelAllBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearStopOrderCancelAllBase input)
        {
            if (input == null)
                return false;
