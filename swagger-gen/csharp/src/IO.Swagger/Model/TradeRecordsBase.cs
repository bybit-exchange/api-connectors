...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradeRecordsBase :  IEquatable<TradeRecordsBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeRecordsBase" /> class.
        /// </summary>
        ...
        public TradeRecordsBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<TradeRecords> result = default(List<TradeRecords>), string timeNow = default(string))
        {
        ...
        public List<TradeRecords> Result { get; set; }
        ...
        {
            return this.Equals(input as TradeRecordsBase);
        }

        /// <summary>
        /// Returns true if TradeRecordsBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TradeRecordsBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeRecordsBase input)
        {
            if (input == null)
                return false;
