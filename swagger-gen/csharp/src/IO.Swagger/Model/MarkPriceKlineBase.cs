...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarkPriceKlineBase :  IEquatable<MarkPriceKlineBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkPriceKlineBase" /> class.
        /// </summary>
        ...
        public MarkPriceKlineBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<MarkPriceKlineInfo> result = default(List<MarkPriceKlineInfo>), string timeNow = default(string))
        {
        ...
        public List<MarkPriceKlineInfo> Result { get; set; }
        ...
        {
            return this.Equals(input as MarkPriceKlineBase);
        }

        /// <summary>
        /// Returns true if MarkPriceKlineBase instances are equal
        /// </summary>
        /// <param name="input">Instance of MarkPriceKlineBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarkPriceKlineBase input)
        {
            if (input == null)
                return false;
