...
namespace IO.Swagger.Model
{
    ...
    public partial class Position :  IEquatable<Position>, IValidatableObject
    {
        ...
        public Position(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
