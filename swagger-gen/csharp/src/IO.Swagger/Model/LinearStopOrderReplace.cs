...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearStopOrderReplace :  IEquatable<LinearStopOrderReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearStopOrderReplace" /> class.
        /// </summary>
        ...
        public LinearStopOrderReplace(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearStopOrderReplace);
        }

        /// <summary>
        /// Returns true if LinearStopOrderReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearStopOrderReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearStopOrderReplace input)
        {
            if (input == null)
                return false;
