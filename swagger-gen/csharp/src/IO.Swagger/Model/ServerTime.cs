...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServerTime :  IEquatable<ServerTime>, IValidatableObject
    {
        /// <summary>
        ...
        public ServerTime(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as ServerTime);
        }

        /// <summary>
        /// Returns true if ServerTime instances are equal
        /// </summary>
        /// <param name="input">Instance of ServerTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServerTime input)
        {
            if (input == null)
                return false;
