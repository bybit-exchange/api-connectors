...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearCreateOrderResultBase :  IEquatable<LinearCreateOrderResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearCreateOrderResultBase" /> class.
        /// </summary>
        ...
        public LinearCreateOrderResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearCreateOrderResultBase);
        }

        /// <summary>
        /// Returns true if LinearCreateOrderResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearCreateOrderResultBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearCreateOrderResultBase input)
        {
            if (input == null)
                return false;
