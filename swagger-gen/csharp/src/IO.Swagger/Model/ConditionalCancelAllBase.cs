...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConditionalCancelAllBase :  IEquatable<ConditionalCancelAllBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionalCancelAllBase" /> class.
        /// </summary>
        ...
        public ConditionalCancelAllBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as ConditionalCancelAllBase);
        }

        /// <summary>
        /// Returns true if ConditionalCancelAllBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ConditionalCancelAllBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConditionalCancelAllBase input)
        {
            if (input == null)
                return false;
