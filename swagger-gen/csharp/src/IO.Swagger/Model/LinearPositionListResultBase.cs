...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearPositionListResultBase :  IEquatable<LinearPositionListResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearPositionListResultBase" /> class.
        /// </summary>
        ...
        public LinearPositionListResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<LinearPositionListResult> result = default(List<LinearPositionListResult>), string timeNow = default(string))
        {
        ...
        public List<LinearPositionListResult> Result { get; set; }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(LinearPositionListResultBase input)
        {
            if (input == null)
                return false;
