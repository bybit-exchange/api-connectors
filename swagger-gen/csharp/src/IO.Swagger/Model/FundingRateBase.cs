...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FundingRateBase :  IEquatable<FundingRateBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundingRateBase" /> class.
        /// </summary>
        ...
        public FundingRateBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as FundingRateBase);
        }

        /// <summary>
        /// Returns true if FundingRateBase instances are equal
        /// </summary>
        /// <param name="input">Instance of FundingRateBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundingRateBase input)
        {
            if (input == null)
                return false;
