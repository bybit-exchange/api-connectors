...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearCancelOrderResultBase :  IEquatable<LinearCancelOrderResultBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearCancelOrderResultBase" /> class.
        /// </summary>
        ...
        public LinearCancelOrderResultBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearCancelOrderResultBase);
        }

        /// <summary>
        /// Returns true if LinearCancelOrderResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearCancelOrderResultBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearCancelOrderResultBase input)
        {
            if (input == null)
                return false;
