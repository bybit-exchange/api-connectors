...
namespace IO.Swagger.Model
{
    ...
    public partial class V2ConditionalBase :  IEquatable<V2ConditionalBase>, IValidatableObject
    {
        ...
        public V2ConditionalBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as V2ConditionalBase);
        }
