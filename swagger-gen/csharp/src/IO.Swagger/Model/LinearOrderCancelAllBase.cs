...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinearOrderCancelAllBase :  IEquatable<LinearOrderCancelAllBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearOrderCancelAllBase" /> class.
        /// </summary>
        ...
        public LinearOrderCancelAllBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<string> result = default(List<string>), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearOrderCancelAllBase);
        }

        /// <summary>
        /// Returns true if LinearOrderCancelAllBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearOrderCancelAllBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearOrderCancelAllBase input)
        {
            if (input == null)
                return false;
