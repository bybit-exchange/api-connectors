...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WalletBalanceBase :  IEquatable<WalletBalanceBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletBalanceBase" /> class.
        /// </summary>
        ...
        public WalletBalanceBase(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), Object result = default(Object), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as WalletBalanceBase);
        }

        /// <summary>
        /// Returns true if WalletBalanceBase instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletBalanceBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletBalanceBase input)
        {
            if (input == null)
                return false;
