...
namespace IO.Swagger.Model
{
    ...
    public partial class LinearClosePnlRecordsResponse :  IEquatable<LinearClosePnlRecordsResponse>, IValidatableObject
    {
        ...
        public LinearClosePnlRecordsResponse(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), List<LinearClosedPnlRecordResult> result = default(List<LinearClosedPnlRecordResult>), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LinearClosePnlRecordsResponse);
        }
