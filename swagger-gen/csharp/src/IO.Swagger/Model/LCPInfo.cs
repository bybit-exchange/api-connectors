...
namespace IO.Swagger.Model
{
    ...
    public partial class LCPInfo :  IEquatable<LCPInfo>, IValidatableObject
    {
        ...
        public LCPInfo(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), LCPInfoBase result = default(LCPInfoBase), string timeNow = default(string))
        {
        ...
        {
            return this.Equals(input as LCPInfo);
        }
