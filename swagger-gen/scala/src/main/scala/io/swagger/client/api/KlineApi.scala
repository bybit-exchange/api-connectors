...
class KlineApi(
   ...
   * @return Any
   */
  def klineGet(symbol: String, interval: String, from: Number, limit: Option[String] = None): Option[Any] = {
   ...
   * @return Future(Any)
   */
  def klineGetAsync(symbol: String, interval: String, from: Number, limit: Option[String] = None): Future[Any] = {
