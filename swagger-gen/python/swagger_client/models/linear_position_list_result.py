...
class LinearPositionListResult(object):
    ...
    def __init__(self, bust_price=None, cum_realised_pnl=None, entry_price=None, free_qty=None, leverage=None, liq_price=None, occ_closing_fee=None, position_margin=None, position_value=None, realised_pnl=None, side=None, size=None, symbol=None, user_id=None):  # noqa: E501
