...
class ConditionalApi(object):
    ...
    def conditional_get_orders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['stop_order_id', 'order_link_id', 'symbol', 'stop_order_status', 'order', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def conditional_replace_with_http_info(self, symbol, **kwargs):  # noqa: E501
        ...
        all_params = ['symbol', 'stop_order_id', 'order_link_id', 'order_id', 'p_r_qty', 'p_r_price', 'p_r_trigger_price']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
