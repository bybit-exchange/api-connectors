...
class OrderApi(object):
    ...
    def order_cancel_v2(self, symbol, **kwargs):  # noqa: E501
        """Get my active order list.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.order_cancel_v2(symbol, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.order_cancel_v2_with_http_info(symbol, **kwargs)  # noqa: E501
        else:
            (data) = self.order_cancel_v2_with_http_info(symbol, **kwargs)  # noqa: E501
            return data

    def order_cancel_v2_with_http_info(self, symbol, **kwargs):  # noqa: E501
        """Get my active order list.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.order_cancel_v2_with_http_info(symbol, async_req=True)
        >>> result = thread.get()
        ...
        if ('symbol' not in params or
                params['symbol'] is None):
            raise ValueError("Missing the required parameter `symbol` when calling `order_cancel_v2`")  # noqa: E501
