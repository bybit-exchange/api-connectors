...
class OrderApi(object):
    ...
    def order_cancel_v2(self, order_id, **kwargs):  # noqa: E501
        """Get my active order list.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.order_cancel_v2(order_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.order_cancel_v2_with_http_info(order_id, **kwargs)  # noqa: E501
        else:
            (data) = self.order_cancel_v2_with_http_info(order_id, **kwargs)  # noqa: E501
            return data

    def order_cancel_v2_with_http_info(self, order_id, **kwargs):  # noqa: E501
        """Get my active order list.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.order_cancel_v2_with_http_info(order_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('order_id' not in params or
                params['order_id'] is None):
            raise ValueError("Missing the required parameter `order_id` when calling `order_cancel_v2`")  # noqa: E501
    ...
    def order_new_v2(self, side, symbol, order_type, qty, price, time_in_force, **kwargs):  # noqa: E501
        ...
        :param bool close_on_trigger: close on trigger
        :param str order_link_id: TCustomized order ID, maximum length at 36 characters, and order ID under the same agency has to be unique.
        :param str trailing_stop: Trailing stop.
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def order_new_v2_with_http_info(self, side, symbol, order_type, qty, price, time_in_force, **kwargs):  # noqa: E501
        ...
        if ('side' not in params or
                params['side'] is None):
            raise ValueError("Missing the required parameter `side` when calling `order_new_v2`")  # noqa: E501
        # verify the required parameter 'symbol' is set
        if ('symbol' not in params or
                params['symbol'] is None):
            raise ValueError("Missing the required parameter `symbol` when calling `order_new_v2`")  # noqa: E501
        # verify the required parameter 'order_type' is set
        if ('order_type' not in params or
                params['order_type'] is None):
            raise ValueError("Missing the required parameter `order_type` when calling `order_new_v2`")  # noqa: E501
        # verify the required parameter 'qty' is set
        if ('qty' not in params or
                params['qty'] is None):
        ...
        if ('time_in_force' not in params or
                params['time_in_force'] is None):
            raise ValueError("Missing the required parameter `time_in_force` when calling `order_new_v2`")  # noqa: E501
