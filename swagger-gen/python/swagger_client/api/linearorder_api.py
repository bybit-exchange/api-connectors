...
class LinearorderApi(object):
    ...
    def linearorder_cancel_all(self, symbol, **kwargs):  # noqa: E501
        """Cancel all active orders.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.linearorder_cancel_all(symbol, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.linearorder_cancel_all_with_http_info(symbol, **kwargs)  # noqa: E501
        else:
            (data) = self.linearorder_cancel_all_with_http_info(symbol, **kwargs)  # noqa: E501
            return data

    def linearorder_cancel_all_with_http_info(self, symbol, **kwargs):  # noqa: E501
        """Cancel all active orders.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.linearorder_cancel_all_with_http_info(symbol, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method linearorder_cancel_all" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('symbol' not in params or
            ...
            raise ValueError("Missing the required parameter `symbol` when calling `linearorder_cancel_all`")  # noqa: E501
    ...
    def linearorder_get_orders(self, **kwargs):  # noqa: E501
        """Get linear Active Orders  # noqa: E501

        This will get linear active orders  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.linearorder_get_orders(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.linearorder_get_orders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.linearorder_get_orders_with_http_info(**kwargs)  # noqa: E501
            return data

    def linearorder_get_orders_with_http_info(self, **kwargs):  # noqa: E501
        """Get linear Active Orders  # noqa: E501

        This will get linear active orders  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.linearorder_get_orders_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method linearorder_get_orders" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def linearorder_query(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.linearorder_query_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.linearorder_query_with_http_info(**kwargs)  # noqa: E501
            return data

    def linearorder_query_with_http_info(self, **kwargs):  # noqa: E501
        """Get Active Orders(real-time)  # noqa: E501

        This will get linear active orders(real-time)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.linearorder_query_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method linearorder_query" % key
                )
            params[key] = val
        del params['kwargs']
