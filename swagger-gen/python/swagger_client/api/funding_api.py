...
class FundingApi(object):
    ...
    def funding_predicted(self, symbol, **kwargs):  # noqa: E501
        """Get predicted funding rate and funding fee.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.funding_predicted(symbol, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.funding_predicted_with_http_info(symbol, **kwargs)  # noqa: E501
        else:
            (data) = self.funding_predicted_with_http_info(symbol, **kwargs)  # noqa: E501
            return data

    def funding_predicted_with_http_info(self, symbol, **kwargs):  # noqa: E501
        """Get predicted funding rate and funding fee.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.funding_predicted_with_http_info(symbol, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method funding_predicted" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'symbol' is set
        if ('symbol' not in params or
                params['symbol'] is None):
            raise ValueError("Missing the required parameter `symbol` when calling `funding_predicted`")  # noqa: E501
