...
#include "LinearStopOrderReplace.h"
...
void LinearStopOrderReplace::validate()
{
    // TODO: implement validation
}

web::json::value LinearStopOrderReplace::toJson() const
{
...
void LinearStopOrderReplace::fromJson(web::json::value& val)
{
...
void LinearStopOrderReplace::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearStopOrderReplace::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearStopOrderReplace::getRetCode() const
{
    return m_Ret_code;
}


void LinearStopOrderReplace::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearStopOrderReplace::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearStopOrderReplace::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearStopOrderReplace::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearStopOrderReplace::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearStopOrderReplace::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearStopOrderReplace::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearStopOrderReplace::getExtCode() const
{
    return m_Ext_code;
}


void LinearStopOrderReplace::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearStopOrderReplace::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearStopOrderReplace::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearStopOrderReplace::getExtInfo() const
{
    return m_Ext_info;
}


void LinearStopOrderReplace::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearStopOrderReplace::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearStopOrderReplace::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearStopOrderReplace::getResult() const
{
    return m_Result;
}


void LinearStopOrderReplace::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearStopOrderReplace::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearStopOrderReplace::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearStopOrderReplace::getTimeNow() const
{
    return m_Time_now;
}


void LinearStopOrderReplace::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearStopOrderReplace::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearStopOrderReplace::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
