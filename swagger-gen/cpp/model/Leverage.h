...
#ifndef IO_SWAGGER_CLIENT_MODEL_Leverage_H_
#define IO_SWAGGER_CLIENT_MODEL_Leverage_H_
...
public:
    ...
    /// 
    /// </summary>
    double getRateLimitStatus() const;
    bool rateLimitStatusIsSet() const;
    void unsetRate_limit_status();
    void setRateLimitStatus(double value);
...
protected:
    ...
    double m_Rate_limit_status;
    bool m_Rate_limit_statusIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_Leverage_H_ */
