...
void LinearOrderReplace::validate()
{
    // TODO: implement validation
}

web::json::value LinearOrderReplace::toJson() const
{
...
void LinearOrderReplace::fromJson(web::json::value& val)
{
...
void LinearOrderReplace::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearOrderReplace::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearOrderReplace::getRetCode() const
{
    return m_Ret_code;
}


void LinearOrderReplace::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearOrderReplace::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearOrderReplace::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearOrderReplace::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearOrderReplace::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearOrderReplace::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearOrderReplace::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearOrderReplace::getExtCode() const
{
    return m_Ext_code;
}


void LinearOrderReplace::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearOrderReplace::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearOrderReplace::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearOrderReplace::getExtInfo() const
{
    return m_Ext_info;
}


void LinearOrderReplace::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearOrderReplace::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearOrderReplace::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearOrderReplace::getResult() const
{
    return m_Result;
}


void LinearOrderReplace::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearOrderReplace::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearOrderReplace::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearOrderReplace::getTimeNow() const
{
    return m_Time_now;
}


void LinearOrderReplace::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearOrderReplace::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearOrderReplace::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
