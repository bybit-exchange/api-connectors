...
void LinearKlineRespBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearKlineRespBase::toJson() const
{
...
void LinearKlineRespBase::fromJson(web::json::value& val)
{
...
void LinearKlineRespBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearKlineRespBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearKlineRespBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearKlineRespBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearKlineRespBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearKlineRespBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearKlineRespBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearKlineRespBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearKlineRespBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearKlineRespBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearKlineRespBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearKlineRespBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearKlineRespBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearKlineRespBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearKlineRespBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearKlineRespBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearKlineRespBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearKlineRespBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearKlineRespBase::getResult() const
{
    return m_Result;
}


void LinearKlineRespBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearKlineRespBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearKlineRespBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearKlineRespBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearKlineRespBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearKlineRespBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearKlineRespBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
