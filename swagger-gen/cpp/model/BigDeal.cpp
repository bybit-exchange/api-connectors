...
void BigDeal::validate()
{
    // TODO: implement validation
}

web::json::value BigDeal::toJson() const
{
...
void BigDeal::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<BigDealInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<BigDealInfo> newItem(new BigDealInfo());
...
void BigDeal::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void BigDeal::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double BigDeal::getRetCode() const
{
    return m_Ret_code;
}


void BigDeal::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool BigDeal::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void BigDeal::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t BigDeal::getRetMsg() const
{
    return m_Ret_msg;
}


void BigDeal::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool BigDeal::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void BigDeal::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t BigDeal::getExtCode() const
{
    return m_Ext_code;
}


void BigDeal::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool BigDeal::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void BigDeal::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t BigDeal::getExtInfo() const
{
    return m_Ext_info;
}


void BigDeal::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool BigDeal::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void BigDeal::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<BigDealInfo>>& BigDeal::getResult()
{
    return m_Result;
}

void BigDeal::setResult(std::vector<std::shared_ptr<BigDealInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool BigDeal::resultIsSet() const
{
    return m_ResultIsSet;
}

void BigDeal::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t BigDeal::getTimeNow() const
{
    return m_Time_now;
}


void BigDeal::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool BigDeal::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void BigDeal::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
