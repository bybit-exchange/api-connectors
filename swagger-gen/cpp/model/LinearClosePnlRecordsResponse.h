...
/*
 * LinearClosePnlRecordsResponse.h
 *
 * Linear Positions Result Base
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_LinearClosePnlRecordsResponse_H_
#define IO_SWAGGER_CLIENT_MODEL_LinearClosePnlRecordsResponse_H_
...
/// Linear Positions Result Base
/// </summary>
class  LinearClosePnlRecordsResponse
    : public ModelBase
{
public:
    LinearClosePnlRecordsResponse();
    virtual ~LinearClosePnlRecordsResponse();
    ...
    /////////////////////////////////////////////
    /// LinearClosePnlRecordsResponse members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LinearClosedPnlRecordResult>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<LinearClosedPnlRecordResult>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<LinearClosedPnlRecordResult>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_LinearClosePnlRecordsResponse_H_ */
