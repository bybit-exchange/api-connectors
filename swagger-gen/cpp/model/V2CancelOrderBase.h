...
#ifndef IO_SWAGGER_CLIENT_MODEL_V2CancelOrderBase_H_
#define IO_SWAGGER_CLIENT_MODEL_V2CancelOrderBase_H_
...
/// Place new conditional order response
/// </summary>
class  V2CancelOrderBase
    : public ModelBase
{
public:
    V2CancelOrderBase();
    virtual ~V2CancelOrderBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_V2CancelOrderBase_H_ */
