...
#include "LinearCreateStopOrderResultBase.h"
...
void LinearCreateStopOrderResultBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearCreateStopOrderResultBase::toJson() const
{
...
void LinearCreateStopOrderResultBase::fromJson(web::json::value& val)
{
...
void LinearCreateStopOrderResultBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearCreateStopOrderResultBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearCreateStopOrderResultBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearCreateStopOrderResultBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearCreateStopOrderResultBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearCreateStopOrderResultBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearCreateStopOrderResultBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearCreateStopOrderResultBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearCreateStopOrderResultBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearCreateStopOrderResultBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearCreateStopOrderResultBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearCreateStopOrderResultBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearCreateStopOrderResultBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearCreateStopOrderResultBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearCreateStopOrderResultBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearCreateStopOrderResultBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearCreateStopOrderResultBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearCreateStopOrderResultBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearCreateStopOrderResultBase::getResult() const
{
    return m_Result;
}


void LinearCreateStopOrderResultBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearCreateStopOrderResultBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearCreateStopOrderResultBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearCreateStopOrderResultBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearCreateStopOrderResultBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearCreateStopOrderResultBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearCreateStopOrderResultBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
