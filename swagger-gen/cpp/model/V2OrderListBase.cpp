...
void V2OrderListBase::validate()
{
    // TODO: implement validation
}

web::json::value V2OrderListBase::toJson() const
{
...
void V2OrderListBase::fromJson(web::json::value& val)
{
...
void V2OrderListBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void V2OrderListBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double V2OrderListBase::getRetCode() const
{
    return m_Ret_code;
}


void V2OrderListBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool V2OrderListBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void V2OrderListBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t V2OrderListBase::getRetMsg() const
{
    return m_Ret_msg;
}


void V2OrderListBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool V2OrderListBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void V2OrderListBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t V2OrderListBase::getExtCode() const
{
    return m_Ext_code;
}


void V2OrderListBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool V2OrderListBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void V2OrderListBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t V2OrderListBase::getExtInfo() const
{
    return m_Ext_info;
}


void V2OrderListBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool V2OrderListBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void V2OrderListBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> V2OrderListBase::getResult() const
{
    return m_Result;
}


void V2OrderListBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool V2OrderListBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void V2OrderListBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t V2OrderListBase::getTimeNow() const
{
    return m_Time_now;
}


void V2OrderListBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool V2OrderListBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void V2OrderListBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
