...
void RiskLimitBase::validate()
{
    // TODO: implement validation
}

web::json::value RiskLimitBase::toJson() const
{
...
void RiskLimitBase::fromJson(web::json::value& val)
{
...
void RiskLimitBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void RiskLimitBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double RiskLimitBase::getRetCode() const
{
    return m_Ret_code;
}


void RiskLimitBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool RiskLimitBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void RiskLimitBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t RiskLimitBase::getRetMsg() const
{
    return m_Ret_msg;
}


void RiskLimitBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool RiskLimitBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void RiskLimitBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t RiskLimitBase::getExtCode() const
{
    return m_Ext_code;
}


void RiskLimitBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool RiskLimitBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void RiskLimitBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t RiskLimitBase::getExtInfo() const
{
    return m_Ext_info;
}


void RiskLimitBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool RiskLimitBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void RiskLimitBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> RiskLimitBase::getResult() const
{
    return m_Result;
}


void RiskLimitBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool RiskLimitBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void RiskLimitBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t RiskLimitBase::getTimeNow() const
{
    return m_Time_now;
}


void RiskLimitBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool RiskLimitBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void RiskLimitBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
