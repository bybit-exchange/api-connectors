...
#ifndef IO_SWAGGER_CLIENT_MODEL_FundRecordBase_H_
#define IO_SWAGGER_CLIENT_MODEL_FundRecordBase_H_
...
/// Get funding record response
/// </summary>
class  FundRecordBase
    : public ModelBase
{
public:
    FundRecordBase();
    virtual ~FundRecordBase();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<FundingRecords>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<FundingRecords>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<FundingRecords>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_FundRecordBase_H_ */
