...
void V2ConditionalBase::validate()
{
    // TODO: implement validation
}

web::json::value V2ConditionalBase::toJson() const
{
...
void V2ConditionalBase::fromJson(web::json::value& val)
{
...
void V2ConditionalBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void V2ConditionalBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double V2ConditionalBase::getRetCode() const
{
    return m_Ret_code;
}


void V2ConditionalBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool V2ConditionalBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void V2ConditionalBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t V2ConditionalBase::getRetMsg() const
{
    return m_Ret_msg;
}


void V2ConditionalBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool V2ConditionalBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void V2ConditionalBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t V2ConditionalBase::getExtCode() const
{
    return m_Ext_code;
}


void V2ConditionalBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool V2ConditionalBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void V2ConditionalBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t V2ConditionalBase::getExtInfo() const
{
    return m_Ext_info;
}


void V2ConditionalBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool V2ConditionalBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void V2ConditionalBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> V2ConditionalBase::getResult() const
{
    return m_Result;
}


void V2ConditionalBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool V2ConditionalBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void V2ConditionalBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t V2ConditionalBase::getTimeNow() const
{
    return m_Time_now;
}


void V2ConditionalBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool V2ConditionalBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void V2ConditionalBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
