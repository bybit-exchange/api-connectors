...
#ifndef IO_SWAGGER_CLIENT_MODEL_LiqRecords_H_
#define IO_SWAGGER_CLIENT_MODEL_LiqRecords_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LiqRecordsInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<LiqRecordsInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<LiqRecordsInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_LiqRecords_H_ */
