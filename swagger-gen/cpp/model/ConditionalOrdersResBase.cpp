...
#include "ConditionalOrdersResBase.h"
...
void ConditionalOrdersResBase::validate()
{
    // TODO: implement validation
}

web::json::value ConditionalOrdersResBase::toJson() const
{
...
void ConditionalOrdersResBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<ConditionalOrdersRes>(nullptr) );
            }
            else
            {
                std::shared_ptr<ConditionalOrdersRes> newItem(new ConditionalOrdersRes());
...
void ConditionalOrdersResBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ConditionalOrdersResBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ConditionalOrdersResBase::getRetCode() const
{
    return m_Ret_code;
}


void ConditionalOrdersResBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool ConditionalOrdersResBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void ConditionalOrdersResBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t ConditionalOrdersResBase::getRetMsg() const
{
    return m_Ret_msg;
}


void ConditionalOrdersResBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool ConditionalOrdersResBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void ConditionalOrdersResBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t ConditionalOrdersResBase::getExtCode() const
{
    return m_Ext_code;
}


void ConditionalOrdersResBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool ConditionalOrdersResBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void ConditionalOrdersResBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t ConditionalOrdersResBase::getExtInfo() const
{
    return m_Ext_info;
}


void ConditionalOrdersResBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool ConditionalOrdersResBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void ConditionalOrdersResBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<ConditionalOrdersRes>>& ConditionalOrdersResBase::getResult()
{
    return m_Result;
}

void ConditionalOrdersResBase::setResult(std::vector<std::shared_ptr<ConditionalOrdersRes>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool ConditionalOrdersResBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void ConditionalOrdersResBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t ConditionalOrdersResBase::getTimeNow() const
{
    return m_Time_now;
}


void ConditionalOrdersResBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool ConditionalOrdersResBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void ConditionalOrdersResBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
