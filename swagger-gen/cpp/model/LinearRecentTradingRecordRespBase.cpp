...
#include "LinearRecentTradingRecordRespBase.h"
...
void LinearRecentTradingRecordRespBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearRecentTradingRecordRespBase::toJson() const
{
...
void LinearRecentTradingRecordRespBase::fromJson(web::json::value& val)
{
...
void LinearRecentTradingRecordRespBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearRecentTradingRecordRespBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearRecentTradingRecordRespBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearRecentTradingRecordRespBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearRecentTradingRecordRespBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearRecentTradingRecordRespBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearRecentTradingRecordRespBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearRecentTradingRecordRespBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearRecentTradingRecordRespBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearRecentTradingRecordRespBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearRecentTradingRecordRespBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearRecentTradingRecordRespBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearRecentTradingRecordRespBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearRecentTradingRecordRespBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearRecentTradingRecordRespBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearRecentTradingRecordRespBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearRecentTradingRecordRespBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearRecentTradingRecordRespBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearRecentTradingRecordRespBase::getResult() const
{
    return m_Result;
}


void LinearRecentTradingRecordRespBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearRecentTradingRecordRespBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearRecentTradingRecordRespBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearRecentTradingRecordRespBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearRecentTradingRecordRespBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearRecentTradingRecordRespBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearRecentTradingRecordRespBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
