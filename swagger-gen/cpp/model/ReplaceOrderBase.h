...
#ifndef IO_SWAGGER_CLIENT_MODEL_ReplaceOrderBase_H_
#define IO_SWAGGER_CLIENT_MODEL_ReplaceOrderBase_H_
...
/// Replace active order response
/// </summary>
class  ReplaceOrderBase
    : public ModelBase
{
public:
    ReplaceOrderBase();
    virtual ~ReplaceOrderBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_ReplaceOrderBase_H_ */
