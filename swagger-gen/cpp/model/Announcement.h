...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AnnouncementInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<AnnouncementInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<AnnouncementInfo>> m_Result;
    bool m_ResultIsSet;
