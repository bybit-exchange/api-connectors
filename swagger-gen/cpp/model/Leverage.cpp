...
Leverage::Leverage()
{
    ...
    m_Rate_limit_status = 0.0;
    m_Rate_limit_statusIsSet = false;
}
...
void Leverage::validate()
{
    // TODO: implement validation
}

web::json::value Leverage::toJson() const
{
    ...
    if(m_Rate_limit_statusIsSet)
    {
        val[utility::conversions::to_string_t("rate_limit_status")] = ModelBase::toJson(m_Rate_limit_status);
    }

    return val;
}

void Leverage::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("rate_limit_status")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("rate_limit_status")];
        if(!fieldValue.is_null())
        {
            setRateLimitStatus(ModelBase::doubleFromJson(fieldValue));
        }
    }
}

void Leverage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Rate_limit_statusIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("rate_limit_status"), m_Rate_limit_status));
    }
}

void Leverage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("rate_limit_status")))
    {
        setRateLimitStatus(ModelBase::doubleFromHttpContent(multipart->getContent(utility::conversions::to_string_t("rate_limit_status"))));
    }
}

double Leverage::getRetCode() const
{
    return m_Ret_code;
}


void Leverage::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool Leverage::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void Leverage::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t Leverage::getRetMsg() const
{
    return m_Ret_msg;
}


void Leverage::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool Leverage::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void Leverage::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t Leverage::getExtCode() const
{
    return m_Ext_code;
}


void Leverage::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool Leverage::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void Leverage::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t Leverage::getExtInfo() const
{
    return m_Ext_info;
}


void Leverage::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool Leverage::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void Leverage::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> Leverage::getResult() const
{
    return m_Result;
}


void Leverage::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool Leverage::resultIsSet() const
{
    return m_ResultIsSet;
}

void Leverage::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t Leverage::getTimeNow() const
{
    return m_Time_now;
}


void Leverage::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool Leverage::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void Leverage::unsetTime_now()
{
    m_Time_nowIsSet = false;
}

double Leverage::getRateLimitStatus() const
{
    return m_Rate_limit_status;
}


void Leverage::setRateLimitStatus(double value)
{
    m_Rate_limit_status = value;
    m_Rate_limit_statusIsSet = true;
}
bool Leverage::rateLimitStatusIsSet() const
{
    return m_Rate_limit_statusIsSet;
}

void Leverage::unsetRate_limit_status()
{
    m_Rate_limit_statusIsSet = false;
}
