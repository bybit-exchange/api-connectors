...
void TradeRecordsBase::validate()
{
    // TODO: implement validation
}

web::json::value TradeRecordsBase::toJson() const
{
...
void TradeRecordsBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<TradeRecords>(nullptr) );
            }
            else
            {
                std::shared_ptr<TradeRecords> newItem(new TradeRecords());
...
void TradeRecordsBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TradeRecordsBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double TradeRecordsBase::getRetCode() const
{
    return m_Ret_code;
}


void TradeRecordsBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool TradeRecordsBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void TradeRecordsBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t TradeRecordsBase::getRetMsg() const
{
    return m_Ret_msg;
}


void TradeRecordsBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool TradeRecordsBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void TradeRecordsBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t TradeRecordsBase::getExtCode() const
{
    return m_Ext_code;
}


void TradeRecordsBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool TradeRecordsBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void TradeRecordsBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t TradeRecordsBase::getExtInfo() const
{
    return m_Ext_info;
}


void TradeRecordsBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool TradeRecordsBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void TradeRecordsBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<TradeRecords>>& TradeRecordsBase::getResult()
{
    return m_Result;
}

void TradeRecordsBase::setResult(std::vector<std::shared_ptr<TradeRecords>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool TradeRecordsBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void TradeRecordsBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t TradeRecordsBase::getTimeNow() const
{
    return m_Time_now;
}


void TradeRecordsBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool TradeRecordsBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void TradeRecordsBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
