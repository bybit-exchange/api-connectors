...
void APIKeyBase::validate()
{
    // TODO: implement validation
}

web::json::value APIKeyBase::toJson() const
{
...
void APIKeyBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<APIKeyInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<APIKeyInfo> newItem(new APIKeyInfo());
...
void APIKeyBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void APIKeyBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double APIKeyBase::getRetCode() const
{
    return m_Ret_code;
}


void APIKeyBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool APIKeyBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void APIKeyBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t APIKeyBase::getRetMsg() const
{
    return m_Ret_msg;
}


void APIKeyBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool APIKeyBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void APIKeyBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t APIKeyBase::getExtCode() const
{
    return m_Ext_code;
}


void APIKeyBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool APIKeyBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void APIKeyBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t APIKeyBase::getExtInfo() const
{
    return m_Ext_info;
}


void APIKeyBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool APIKeyBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void APIKeyBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<APIKeyInfo>>& APIKeyBase::getResult()
{
    return m_Result;
}

void APIKeyBase::setResult(std::vector<std::shared_ptr<APIKeyInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool APIKeyBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void APIKeyBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t APIKeyBase::getTimeNow() const
{
    return m_Time_now;
}


void APIKeyBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool APIKeyBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void APIKeyBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
