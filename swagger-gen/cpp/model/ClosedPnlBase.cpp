...
void ClosedPnlBase::validate()
{
    // TODO: implement validation
}

web::json::value ClosedPnlBase::toJson() const
{
...
void ClosedPnlBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<ClosedPnlInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<ClosedPnlInfo> newItem(new ClosedPnlInfo());
...
void ClosedPnlBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ClosedPnlBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ClosedPnlBase::getRetCode() const
{
    return m_Ret_code;
}


void ClosedPnlBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool ClosedPnlBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void ClosedPnlBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t ClosedPnlBase::getRetMsg() const
{
    return m_Ret_msg;
}


void ClosedPnlBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool ClosedPnlBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void ClosedPnlBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t ClosedPnlBase::getExtCode() const
{
    return m_Ext_code;
}


void ClosedPnlBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool ClosedPnlBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void ClosedPnlBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t ClosedPnlBase::getExtInfo() const
{
    return m_Ext_info;
}


void ClosedPnlBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool ClosedPnlBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void ClosedPnlBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<ClosedPnlInfo>>& ClosedPnlBase::getResult()
{
    return m_Result;
}

void ClosedPnlBase::setResult(std::vector<std::shared_ptr<ClosedPnlInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool ClosedPnlBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void ClosedPnlBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t ClosedPnlBase::getTimeNow() const
{
    return m_Time_now;
}


void ClosedPnlBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool ClosedPnlBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void ClosedPnlBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
