...
void OpenInterest::validate()
{
    // TODO: implement validation
}

web::json::value OpenInterest::toJson() const
{
...
void OpenInterest::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<OpenInterestInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<OpenInterestInfo> newItem(new OpenInterestInfo());
...
void OpenInterest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void OpenInterest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double OpenInterest::getRetCode() const
{
    return m_Ret_code;
}


void OpenInterest::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool OpenInterest::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void OpenInterest::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t OpenInterest::getRetMsg() const
{
    return m_Ret_msg;
}


void OpenInterest::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool OpenInterest::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void OpenInterest::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t OpenInterest::getExtCode() const
{
    return m_Ext_code;
}


void OpenInterest::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool OpenInterest::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void OpenInterest::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t OpenInterest::getExtInfo() const
{
    return m_Ext_info;
}


void OpenInterest::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool OpenInterest::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void OpenInterest::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<OpenInterestInfo>>& OpenInterest::getResult()
{
    return m_Result;
}

void OpenInterest::setResult(std::vector<std::shared_ptr<OpenInterestInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool OpenInterest::resultIsSet() const
{
    return m_ResultIsSet;
}

void OpenInterest::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t OpenInterest::getTimeNow() const
{
    return m_Time_now;
}


void OpenInterest::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool OpenInterest::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void OpenInterest::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
