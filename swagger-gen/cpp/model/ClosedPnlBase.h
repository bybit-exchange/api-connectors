...
#ifndef IO_SWAGGER_CLIENT_MODEL_ClosedPnlBase_H_
#define IO_SWAGGER_CLIENT_MODEL_ClosedPnlBase_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ClosedPnlInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<ClosedPnlInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<ClosedPnlInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_ClosedPnlBase_H_ */
