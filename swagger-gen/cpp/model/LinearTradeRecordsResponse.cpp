...
#include "LinearTradeRecordsResponse.h"
...
void LinearTradeRecordsResponse::validate()
{
    // TODO: implement validation
}

web::json::value LinearTradeRecordsResponse::toJson() const
{
...
void LinearTradeRecordsResponse::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<LinearTradeRecordItem>(nullptr) );
            }
            else
            {
                std::shared_ptr<LinearTradeRecordItem> newItem(new LinearTradeRecordItem());
...
void LinearTradeRecordsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearTradeRecordsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearTradeRecordsResponse::getRetCode() const
{
    return m_Ret_code;
}


void LinearTradeRecordsResponse::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearTradeRecordsResponse::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearTradeRecordsResponse::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearTradeRecordsResponse::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearTradeRecordsResponse::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearTradeRecordsResponse::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearTradeRecordsResponse::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearTradeRecordsResponse::getExtCode() const
{
    return m_Ext_code;
}


void LinearTradeRecordsResponse::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearTradeRecordsResponse::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearTradeRecordsResponse::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearTradeRecordsResponse::getExtInfo() const
{
    return m_Ext_info;
}


void LinearTradeRecordsResponse::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearTradeRecordsResponse::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearTradeRecordsResponse::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<LinearTradeRecordItem>>& LinearTradeRecordsResponse::getResult()
{
    return m_Result;
}

void LinearTradeRecordsResponse::setResult(std::vector<std::shared_ptr<LinearTradeRecordItem>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearTradeRecordsResponse::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearTradeRecordsResponse::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearTradeRecordsResponse::getTimeNow() const
{
    return m_Time_now;
}


void LinearTradeRecordsResponse::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearTradeRecordsResponse::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearTradeRecordsResponse::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
