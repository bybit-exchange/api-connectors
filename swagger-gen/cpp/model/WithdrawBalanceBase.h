...
/*
 * WithdrawBalanceBase.h
 *
 * Get account withdraw balance response
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_WithdrawBalanceBase_H_
#define IO_SWAGGER_CLIENT_MODEL_WithdrawBalanceBase_H_
...
/// Get account withdraw balance response
/// </summary>
class  WithdrawBalanceBase
    : public ModelBase
{
public:
    WithdrawBalanceBase();
    virtual ~WithdrawBalanceBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_WithdrawBalanceBase_H_ */
