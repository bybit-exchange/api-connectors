...
void MarkPriceKlineBase::validate()
{
    // TODO: implement validation
}

web::json::value MarkPriceKlineBase::toJson() const
{
...
void MarkPriceKlineBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<MarkPriceKlineInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<MarkPriceKlineInfo> newItem(new MarkPriceKlineInfo());
...
void MarkPriceKlineBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void MarkPriceKlineBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double MarkPriceKlineBase::getRetCode() const
{
    return m_Ret_code;
}


void MarkPriceKlineBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool MarkPriceKlineBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void MarkPriceKlineBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t MarkPriceKlineBase::getRetMsg() const
{
    return m_Ret_msg;
}


void MarkPriceKlineBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool MarkPriceKlineBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void MarkPriceKlineBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t MarkPriceKlineBase::getExtCode() const
{
    return m_Ext_code;
}


void MarkPriceKlineBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool MarkPriceKlineBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void MarkPriceKlineBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t MarkPriceKlineBase::getExtInfo() const
{
    return m_Ext_info;
}


void MarkPriceKlineBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool MarkPriceKlineBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void MarkPriceKlineBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<MarkPriceKlineInfo>>& MarkPriceKlineBase::getResult()
{
    return m_Result;
}

void MarkPriceKlineBase::setResult(std::vector<std::shared_ptr<MarkPriceKlineInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool MarkPriceKlineBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void MarkPriceKlineBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t MarkPriceKlineBase::getTimeNow() const
{
    return m_Time_now;
}


void MarkPriceKlineBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool MarkPriceKlineBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void MarkPriceKlineBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
