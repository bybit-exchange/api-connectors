...
#include "LinearStopOrderRecordsResponseBase.h"
...
void LinearStopOrderRecordsResponseBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearStopOrderRecordsResponseBase::toJson() const
{
...
void LinearStopOrderRecordsResponseBase::fromJson(web::json::value& val)
{
...
void LinearStopOrderRecordsResponseBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearStopOrderRecordsResponseBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearStopOrderRecordsResponseBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearStopOrderRecordsResponseBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearStopOrderRecordsResponseBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearStopOrderRecordsResponseBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearStopOrderRecordsResponseBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearStopOrderRecordsResponseBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearStopOrderRecordsResponseBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearStopOrderRecordsResponseBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearStopOrderRecordsResponseBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearStopOrderRecordsResponseBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearStopOrderRecordsResponseBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearStopOrderRecordsResponseBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearStopOrderRecordsResponseBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearStopOrderRecordsResponseBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearStopOrderRecordsResponseBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearStopOrderRecordsResponseBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearStopOrderRecordsResponseBase::getResult() const
{
    return m_Result;
}


void LinearStopOrderRecordsResponseBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearStopOrderRecordsResponseBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearStopOrderRecordsResponseBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearStopOrderRecordsResponseBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearStopOrderRecordsResponseBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearStopOrderRecordsResponseBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearStopOrderRecordsResponseBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
