...
#include "LinearOrderRecordsResponse.h"
...
void LinearOrderRecordsResponse::validate()
{
    // TODO: implement validation
}

web::json::value LinearOrderRecordsResponse::toJson() const
{
...
void LinearOrderRecordsResponse::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("data")].as_array() )
        {
            if(item.is_null())
            {
                m_Data.push_back( std::shared_ptr<LinearListOrderResult>(nullptr) );
            }
            else
            {
                std::shared_ptr<LinearListOrderResult> newItem(new LinearListOrderResult());
...
void LinearOrderRecordsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearOrderRecordsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t LinearOrderRecordsResponse::getCurrentPage() const
{
    return m_Current_page;
}


void LinearOrderRecordsResponse::setCurrentPage(int64_t value)
{
    m_Current_page = value;
    m_Current_pageIsSet = true;
}
bool LinearOrderRecordsResponse::currentPageIsSet() const
{
    return m_Current_pageIsSet;
}

void LinearOrderRecordsResponse::unsetCurrent_page()
{
    m_Current_pageIsSet = false;
}

std::vector<std::shared_ptr<LinearListOrderResult>>& LinearOrderRecordsResponse::getData()
{
    return m_Data;
}

void LinearOrderRecordsResponse::setData(std::vector<std::shared_ptr<LinearListOrderResult>> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
bool LinearOrderRecordsResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void LinearOrderRecordsResponse::unsetData()
{
    m_DataIsSet = false;
}
