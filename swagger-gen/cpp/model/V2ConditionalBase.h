...
#ifndef IO_SWAGGER_CLIENT_MODEL_V2ConditionalBase_H_
#define IO_SWAGGER_CLIENT_MODEL_V2ConditionalBase_H_
...
/// Place new conditional order response
/// </summary>
class  V2ConditionalBase
    : public ModelBase
{
public:
    V2ConditionalBase();
    virtual ~V2ConditionalBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_V2ConditionalBase_H_ */
