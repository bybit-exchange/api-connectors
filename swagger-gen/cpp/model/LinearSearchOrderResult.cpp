...
#include "LinearSearchOrderResult.h"
...
void LinearSearchOrderResult::validate()
{
    // TODO: implement validation
}

web::json::value LinearSearchOrderResult::toJson() const
{
...
void LinearSearchOrderResult::fromJson(web::json::value& val)
{
...
void LinearSearchOrderResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearSearchOrderResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t LinearSearchOrderResult::getCreatedTime() const
{
    return m_Created_time;
}


void LinearSearchOrderResult::setCreatedTime(utility::string_t value)
{
    m_Created_time = value;
    m_Created_timeIsSet = true;
}
bool LinearSearchOrderResult::createdTimeIsSet() const
{
    return m_Created_timeIsSet;
}

void LinearSearchOrderResult::unsetCreated_time()
{
    m_Created_timeIsSet = false;
}

double LinearSearchOrderResult::getCumExecFee() const
{
    return m_Cum_exec_fee;
}


void LinearSearchOrderResult::setCumExecFee(double value)
{
    m_Cum_exec_fee = value;
    m_Cum_exec_feeIsSet = true;
}
bool LinearSearchOrderResult::cumExecFeeIsSet() const
{
    return m_Cum_exec_feeIsSet;
}

void LinearSearchOrderResult::unsetCum_exec_fee()
{
    m_Cum_exec_feeIsSet = false;
}

double LinearSearchOrderResult::getCumExecQty() const
{
    return m_Cum_exec_qty;
}


void LinearSearchOrderResult::setCumExecQty(double value)
{
    m_Cum_exec_qty = value;
    m_Cum_exec_qtyIsSet = true;
}
bool LinearSearchOrderResult::cumExecQtyIsSet() const
{
    return m_Cum_exec_qtyIsSet;
}

void LinearSearchOrderResult::unsetCum_exec_qty()
{
    m_Cum_exec_qtyIsSet = false;
}

double LinearSearchOrderResult::getCumExecValue() const
{
    return m_Cum_exec_value;
}


void LinearSearchOrderResult::setCumExecValue(double value)
{
    m_Cum_exec_value = value;
    m_Cum_exec_valueIsSet = true;
}
bool LinearSearchOrderResult::cumExecValueIsSet() const
{
    return m_Cum_exec_valueIsSet;
}

void LinearSearchOrderResult::unsetCum_exec_value()
{
    m_Cum_exec_valueIsSet = false;
}

double LinearSearchOrderResult::getLastExecPrice() const
{
    return m_Last_exec_price;
}


void LinearSearchOrderResult::setLastExecPrice(double value)
{
    m_Last_exec_price = value;
    m_Last_exec_priceIsSet = true;
}
bool LinearSearchOrderResult::lastExecPriceIsSet() const
{
    return m_Last_exec_priceIsSet;
}

void LinearSearchOrderResult::unsetLast_exec_price()
{
    m_Last_exec_priceIsSet = false;
}

utility::string_t LinearSearchOrderResult::getOrderId() const
{
    return m_Order_id;
}


void LinearSearchOrderResult::setOrderId(utility::string_t value)
{
    m_Order_id = value;
    m_Order_idIsSet = true;
}
bool LinearSearchOrderResult::orderIdIsSet() const
{
    return m_Order_idIsSet;
}

void LinearSearchOrderResult::unsetOrder_id()
{
    m_Order_idIsSet = false;
}

utility::string_t LinearSearchOrderResult::getOrderLinkId() const
{
    return m_Order_link_id;
}


void LinearSearchOrderResult::setOrderLinkId(utility::string_t value)
{
    m_Order_link_id = value;
    m_Order_link_idIsSet = true;
}
bool LinearSearchOrderResult::orderLinkIdIsSet() const
{
    return m_Order_link_idIsSet;
}

void LinearSearchOrderResult::unsetOrder_link_id()
{
    m_Order_link_idIsSet = false;
}

utility::string_t LinearSearchOrderResult::getOrderStatus() const
{
    return m_Order_status;
}


void LinearSearchOrderResult::setOrderStatus(utility::string_t value)
{
    m_Order_status = value;
    m_Order_statusIsSet = true;
}
bool LinearSearchOrderResult::orderStatusIsSet() const
{
    return m_Order_statusIsSet;
}

void LinearSearchOrderResult::unsetOrder_status()
{
    m_Order_statusIsSet = false;
}

utility::string_t LinearSearchOrderResult::getOrderType() const
{
    return m_Order_type;
}


void LinearSearchOrderResult::setOrderType(utility::string_t value)
{
    m_Order_type = value;
    m_Order_typeIsSet = true;
}
bool LinearSearchOrderResult::orderTypeIsSet() const
{
    return m_Order_typeIsSet;
}

void LinearSearchOrderResult::unsetOrder_type()
{
    m_Order_typeIsSet = false;
}

double LinearSearchOrderResult::getPrice() const
{
    return m_Price;
}


void LinearSearchOrderResult::setPrice(double value)
{
    m_Price = value;
    m_PriceIsSet = true;
}
bool LinearSearchOrderResult::priceIsSet() const
{
    return m_PriceIsSet;
}

void LinearSearchOrderResult::unsetPrice()
{
    m_PriceIsSet = false;
}

double LinearSearchOrderResult::getQty() const
{
    return m_Qty;
}


void LinearSearchOrderResult::setQty(double value)
{
    m_Qty = value;
    m_QtyIsSet = true;
}
bool LinearSearchOrderResult::qtyIsSet() const
{
    return m_QtyIsSet;
}

void LinearSearchOrderResult::unsetQty()
{
    m_QtyIsSet = false;
}

bool LinearSearchOrderResult::isReduceOnly() const
{
    return m_Reduce_only;
}


void LinearSearchOrderResult::setReduceOnly(bool value)
{
    m_Reduce_only = value;
    m_Reduce_onlyIsSet = true;
}
bool LinearSearchOrderResult::reduceOnlyIsSet() const
{
    return m_Reduce_onlyIsSet;
}

void LinearSearchOrderResult::unsetReduce_only()
{
    m_Reduce_onlyIsSet = false;
}

utility::string_t LinearSearchOrderResult::getSide() const
{
    return m_Side;
}


void LinearSearchOrderResult::setSide(utility::string_t value)
{
    m_Side = value;
    m_SideIsSet = true;
}
bool LinearSearchOrderResult::sideIsSet() const
{
    return m_SideIsSet;
}

void LinearSearchOrderResult::unsetSide()
{
    m_SideIsSet = false;
}

utility::string_t LinearSearchOrderResult::getSymbol() const
{
    return m_Symbol;
}


void LinearSearchOrderResult::setSymbol(utility::string_t value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}
bool LinearSearchOrderResult::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void LinearSearchOrderResult::unsetSymbol()
{
    m_SymbolIsSet = false;
}

utility::string_t LinearSearchOrderResult::getTimeInForce() const
{
    return m_Time_in_force;
}


void LinearSearchOrderResult::setTimeInForce(utility::string_t value)
{
    m_Time_in_force = value;
    m_Time_in_forceIsSet = true;
}
bool LinearSearchOrderResult::timeInForceIsSet() const
{
    return m_Time_in_forceIsSet;
}

void LinearSearchOrderResult::unsetTime_in_force()
{
    m_Time_in_forceIsSet = false;
}

utility::string_t LinearSearchOrderResult::getUpdatedTime() const
{
    return m_Updated_time;
}


void LinearSearchOrderResult::setUpdatedTime(utility::string_t value)
{
    m_Updated_time = value;
    m_Updated_timeIsSet = true;
}
bool LinearSearchOrderResult::updatedTimeIsSet() const
{
    return m_Updated_timeIsSet;
}

void LinearSearchOrderResult::unsetUpdated_time()
{
    m_Updated_timeIsSet = false;
}

int64_t LinearSearchOrderResult::getUserId() const
{
    return m_User_id;
}


void LinearSearchOrderResult::setUserId(int64_t value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}
bool LinearSearchOrderResult::userIdIsSet() const
{
    return m_User_idIsSet;
}

void LinearSearchOrderResult::unsetUser_id()
{
    m_User_idIsSet = false;
}

double LinearSearchOrderResult::getTakeProfit() const
{
    return m_Take_profit;
}


void LinearSearchOrderResult::setTakeProfit(double value)
{
    m_Take_profit = value;
    m_Take_profitIsSet = true;
}
bool LinearSearchOrderResult::takeProfitIsSet() const
{
    return m_Take_profitIsSet;
}

void LinearSearchOrderResult::unsetTake_profit()
{
    m_Take_profitIsSet = false;
}

double LinearSearchOrderResult::getStopLoss() const
{
    return m_Stop_loss;
}


void LinearSearchOrderResult::setStopLoss(double value)
{
    m_Stop_loss = value;
    m_Stop_lossIsSet = true;
}
bool LinearSearchOrderResult::stopLossIsSet() const
{
    return m_Stop_lossIsSet;
}

void LinearSearchOrderResult::unsetStop_loss()
{
    m_Stop_lossIsSet = false;
}

utility::string_t LinearSearchOrderResult::getTpTriggerBy() const
{
    return m_Tp_trigger_by;
}


void LinearSearchOrderResult::setTpTriggerBy(utility::string_t value)
{
    m_Tp_trigger_by = value;
    m_Tp_trigger_byIsSet = true;
}
bool LinearSearchOrderResult::tpTriggerByIsSet() const
{
    return m_Tp_trigger_byIsSet;
}

void LinearSearchOrderResult::unsetTp_trigger_by()
{
    m_Tp_trigger_byIsSet = false;
}

utility::string_t LinearSearchOrderResult::getSlTriggerBy() const
{
    return m_Sl_trigger_by;
}


void LinearSearchOrderResult::setSlTriggerBy(utility::string_t value)
{
    m_Sl_trigger_by = value;
    m_Sl_trigger_byIsSet = true;
}
bool LinearSearchOrderResult::slTriggerByIsSet() const
{
    return m_Sl_trigger_byIsSet;
}

void LinearSearchOrderResult::unsetSl_trigger_by()
{
    m_Sl_trigger_byIsSet = false;
}
