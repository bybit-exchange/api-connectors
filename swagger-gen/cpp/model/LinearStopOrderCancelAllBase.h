...
/*
 * LinearStopOrderCancelAllBase.h
 *
 * Cancel all linear stop orders response
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_LinearStopOrderCancelAllBase_H_
#define IO_SWAGGER_CLIENT_MODEL_LinearStopOrderCancelAllBase_H_
...
/// Cancel all linear stop orders response
/// </summary>
class  LinearStopOrderCancelAllBase
    : public ModelBase
{
public:
    LinearStopOrderCancelAllBase();
    virtual ~LinearStopOrderCancelAllBase();
    ...
    /////////////////////////////////////////////
    /// LinearStopOrderCancelAllBase members
    ...
    /// 
    /// </summary>
    std::vector<utility::string_t>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<utility::string_t> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<utility::string_t> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_LinearStopOrderCancelAllBase_H_ */
