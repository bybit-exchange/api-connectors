...
void WithdrawResBase::validate()
{
    // TODO: implement validation
}

web::json::value WithdrawResBase::toJson() const
{
...
void WithdrawResBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<WithdrawRecords>(nullptr) );
            }
            else
            {
                std::shared_ptr<WithdrawRecords> newItem(new WithdrawRecords());
...
void WithdrawResBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void WithdrawResBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double WithdrawResBase::getRetCode() const
{
    return m_Ret_code;
}


void WithdrawResBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool WithdrawResBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void WithdrawResBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t WithdrawResBase::getRetMsg() const
{
    return m_Ret_msg;
}


void WithdrawResBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool WithdrawResBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void WithdrawResBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t WithdrawResBase::getExtCode() const
{
    return m_Ext_code;
}


void WithdrawResBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool WithdrawResBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void WithdrawResBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t WithdrawResBase::getExtInfo() const
{
    return m_Ext_info;
}


void WithdrawResBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool WithdrawResBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void WithdrawResBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<WithdrawRecords>>& WithdrawResBase::getResult()
{
    return m_Result;
}

void WithdrawResBase::setResult(std::vector<std::shared_ptr<WithdrawRecords>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool WithdrawResBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void WithdrawResBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t WithdrawResBase::getTimeNow() const
{
    return m_Time_now;
}


void WithdrawResBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool WithdrawResBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void WithdrawResBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
