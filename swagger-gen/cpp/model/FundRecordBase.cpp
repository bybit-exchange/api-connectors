...
void FundRecordBase::validate()
{
    // TODO: implement validation
}

web::json::value FundRecordBase::toJson() const
{
...
void FundRecordBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<FundingRecords>(nullptr) );
            }
            else
            {
                std::shared_ptr<FundingRecords> newItem(new FundingRecords());
...
void FundRecordBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void FundRecordBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double FundRecordBase::getRetCode() const
{
    return m_Ret_code;
}


void FundRecordBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool FundRecordBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void FundRecordBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t FundRecordBase::getRetMsg() const
{
    return m_Ret_msg;
}


void FundRecordBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool FundRecordBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void FundRecordBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t FundRecordBase::getExtCode() const
{
    return m_Ext_code;
}


void FundRecordBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool FundRecordBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void FundRecordBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t FundRecordBase::getExtInfo() const
{
    return m_Ext_info;
}


void FundRecordBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool FundRecordBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void FundRecordBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<FundingRecords>>& FundRecordBase::getResult()
{
    return m_Result;
}

void FundRecordBase::setResult(std::vector<std::shared_ptr<FundingRecords>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool FundRecordBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void FundRecordBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t FundRecordBase::getTimeNow() const
{
    return m_Time_now;
}


void FundRecordBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool FundRecordBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void FundRecordBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
