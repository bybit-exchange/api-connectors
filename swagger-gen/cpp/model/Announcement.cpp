...
void Announcement::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<AnnouncementInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<AnnouncementInfo> newItem(new AnnouncementInfo());
...
double Announcement::getRetCode() const
{
    return m_Ret_code;
}


void Announcement::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool Announcement::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void Announcement::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t Announcement::getRetMsg() const
{
    return m_Ret_msg;
}


void Announcement::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool Announcement::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void Announcement::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t Announcement::getExtCode() const
{
    return m_Ext_code;
}


void Announcement::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool Announcement::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void Announcement::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t Announcement::getExtInfo() const
{
    return m_Ext_info;
}


void Announcement::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool Announcement::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void Announcement::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<AnnouncementInfo>>& Announcement::getResult()
{
    return m_Result;
}

void Announcement::setResult(std::vector<std::shared_ptr<AnnouncementInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool Announcement::resultIsSet() const
{
    return m_ResultIsSet;
}

void Announcement::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t Announcement::getTimeNow() const
{
    return m_Time_now;
}


void Announcement::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool Announcement::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void Announcement::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
