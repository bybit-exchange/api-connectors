...
#include "LinearSetTradingStopResult.h"
...
void LinearSetTradingStopResult::validate()
{
    // TODO: implement validation
}

web::json::value LinearSetTradingStopResult::toJson() const
{
...
void LinearSetTradingStopResult::fromJson(web::json::value& val)
{
...
void LinearSetTradingStopResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearSetTradingStopResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearSetTradingStopResult::getRetCode() const
{
    return m_Ret_code;
}


void LinearSetTradingStopResult::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearSetTradingStopResult::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearSetTradingStopResult::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearSetTradingStopResult::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearSetTradingStopResult::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearSetTradingStopResult::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearSetTradingStopResult::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearSetTradingStopResult::getExtCode() const
{
    return m_Ext_code;
}


void LinearSetTradingStopResult::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearSetTradingStopResult::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearSetTradingStopResult::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearSetTradingStopResult::getExtInfo() const
{
    return m_Ext_info;
}


void LinearSetTradingStopResult::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearSetTradingStopResult::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearSetTradingStopResult::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

utility::string_t LinearSetTradingStopResult::getTimeNow() const
{
    return m_Time_now;
}


void LinearSetTradingStopResult::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearSetTradingStopResult::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearSetTradingStopResult::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
