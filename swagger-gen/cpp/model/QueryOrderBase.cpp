...
void QueryOrderBase::validate()
{
    // TODO: implement validation
}

web::json::value QueryOrderBase::toJson() const
{
...
void QueryOrderBase::fromJson(web::json::value& val)
{
...
void QueryOrderBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void QueryOrderBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double QueryOrderBase::getRetCode() const
{
    return m_Ret_code;
}


void QueryOrderBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool QueryOrderBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void QueryOrderBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t QueryOrderBase::getRetMsg() const
{
    return m_Ret_msg;
}


void QueryOrderBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool QueryOrderBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void QueryOrderBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t QueryOrderBase::getExtCode() const
{
    return m_Ext_code;
}


void QueryOrderBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool QueryOrderBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void QueryOrderBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t QueryOrderBase::getExtInfo() const
{
    return m_Ext_info;
}


void QueryOrderBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool QueryOrderBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void QueryOrderBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> QueryOrderBase::getResult() const
{
    return m_Result;
}


void QueryOrderBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool QueryOrderBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void QueryOrderBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t QueryOrderBase::getTimeNow() const
{
    return m_Time_now;
}


void QueryOrderBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool QueryOrderBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void QueryOrderBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
