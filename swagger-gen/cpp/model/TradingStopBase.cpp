...
void TradingStopBase::validate()
{
    // TODO: implement validation
}

web::json::value TradingStopBase::toJson() const
{
...
void TradingStopBase::fromJson(web::json::value& val)
{
...
void TradingStopBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TradingStopBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double TradingStopBase::getRetCode() const
{
    return m_Ret_code;
}


void TradingStopBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool TradingStopBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void TradingStopBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t TradingStopBase::getRetMsg() const
{
    return m_Ret_msg;
}


void TradingStopBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool TradingStopBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void TradingStopBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t TradingStopBase::getExtCode() const
{
    return m_Ext_code;
}


void TradingStopBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool TradingStopBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void TradingStopBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t TradingStopBase::getExtInfo() const
{
    return m_Ext_info;
}


void TradingStopBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool TradingStopBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void TradingStopBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> TradingStopBase::getResult() const
{
    return m_Result;
}


void TradingStopBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool TradingStopBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void TradingStopBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t TradingStopBase::getTimeNow() const
{
    return m_Time_now;
}


void TradingStopBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool TradingStopBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void TradingStopBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
