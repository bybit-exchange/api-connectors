...
#include "ConditionalCancelAllBase.h"
...
void ConditionalCancelAllBase::validate()
{
    // TODO: implement validation
}

web::json::value ConditionalCancelAllBase::toJson() const
{
...
void ConditionalCancelAllBase::fromJson(web::json::value& val)
{
...
void ConditionalCancelAllBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ConditionalCancelAllBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ConditionalCancelAllBase::getRetCode() const
{
    return m_Ret_code;
}


void ConditionalCancelAllBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool ConditionalCancelAllBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void ConditionalCancelAllBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t ConditionalCancelAllBase::getRetMsg() const
{
    return m_Ret_msg;
}


void ConditionalCancelAllBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool ConditionalCancelAllBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void ConditionalCancelAllBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t ConditionalCancelAllBase::getExtCode() const
{
    return m_Ext_code;
}


void ConditionalCancelAllBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool ConditionalCancelAllBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void ConditionalCancelAllBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t ConditionalCancelAllBase::getExtInfo() const
{
    return m_Ext_info;
}


void ConditionalCancelAllBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool ConditionalCancelAllBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void ConditionalCancelAllBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> ConditionalCancelAllBase::getResult() const
{
    return m_Result;
}


void ConditionalCancelAllBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool ConditionalCancelAllBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void ConditionalCancelAllBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t ConditionalCancelAllBase::getTimeNow() const
{
    return m_Time_now;
}


void ConditionalCancelAllBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool ConditionalCancelAllBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void ConditionalCancelAllBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
