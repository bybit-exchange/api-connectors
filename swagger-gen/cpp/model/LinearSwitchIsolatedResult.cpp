...
#include "LinearSwitchIsolatedResult.h"
...
void LinearSwitchIsolatedResult::validate()
{
    // TODO: implement validation
}

web::json::value LinearSwitchIsolatedResult::toJson() const
{
...
void LinearSwitchIsolatedResult::fromJson(web::json::value& val)
{
...
void LinearSwitchIsolatedResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearSwitchIsolatedResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearSwitchIsolatedResult::getRetCode() const
{
    return m_Ret_code;
}


void LinearSwitchIsolatedResult::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearSwitchIsolatedResult::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearSwitchIsolatedResult::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearSwitchIsolatedResult::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearSwitchIsolatedResult::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearSwitchIsolatedResult::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearSwitchIsolatedResult::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearSwitchIsolatedResult::getExtCode() const
{
    return m_Ext_code;
}


void LinearSwitchIsolatedResult::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearSwitchIsolatedResult::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearSwitchIsolatedResult::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearSwitchIsolatedResult::getExtInfo() const
{
    return m_Ext_info;
}


void LinearSwitchIsolatedResult::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearSwitchIsolatedResult::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearSwitchIsolatedResult::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

utility::string_t LinearSwitchIsolatedResult::getTimeNow() const
{
    return m_Time_now;
}


void LinearSwitchIsolatedResult::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearSwitchIsolatedResult::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearSwitchIsolatedResult::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
