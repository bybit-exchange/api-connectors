...
/*
 * FundingPredictedBase.h
 *
 * Get the last funding fee
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_FundingPredictedBase_H_
#define IO_SWAGGER_CLIENT_MODEL_FundingPredictedBase_H_
...
/// Get the last funding fee
/// </summary>
class  FundingPredictedBase
    : public ModelBase
{
public:
    FundingPredictedBase();
    virtual ~FundingPredictedBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_FundingPredictedBase_H_ */
