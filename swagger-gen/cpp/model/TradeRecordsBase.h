...
#ifndef IO_SWAGGER_CLIENT_MODEL_TradeRecordsBase_H_
#define IO_SWAGGER_CLIENT_MODEL_TradeRecordsBase_H_
...
/// Get the trade records of a order response
/// </summary>
class  TradeRecordsBase
    : public ModelBase
{
public:
    TradeRecordsBase();
    virtual ~TradeRecordsBase();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TradeRecords>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<TradeRecords>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<TradeRecords>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_TradeRecordsBase_H_ */
