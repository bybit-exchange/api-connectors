...
#include "LinearCreateOrderResultBase.h"
...
void LinearCreateOrderResultBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearCreateOrderResultBase::toJson() const
{
...
void LinearCreateOrderResultBase::fromJson(web::json::value& val)
{
...
void LinearCreateOrderResultBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearCreateOrderResultBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearCreateOrderResultBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearCreateOrderResultBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearCreateOrderResultBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearCreateOrderResultBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearCreateOrderResultBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearCreateOrderResultBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearCreateOrderResultBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearCreateOrderResultBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearCreateOrderResultBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearCreateOrderResultBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearCreateOrderResultBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearCreateOrderResultBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearCreateOrderResultBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearCreateOrderResultBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearCreateOrderResultBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearCreateOrderResultBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearCreateOrderResultBase::getResult() const
{
    return m_Result;
}


void LinearCreateOrderResultBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearCreateOrderResultBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearCreateOrderResultBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearCreateOrderResultBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearCreateOrderResultBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearCreateOrderResultBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearCreateOrderResultBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
