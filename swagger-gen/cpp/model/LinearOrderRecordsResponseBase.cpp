...
#include "LinearOrderRecordsResponseBase.h"
...
void LinearOrderRecordsResponseBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearOrderRecordsResponseBase::toJson() const
{
...
void LinearOrderRecordsResponseBase::fromJson(web::json::value& val)
{
...
void LinearOrderRecordsResponseBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearOrderRecordsResponseBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearOrderRecordsResponseBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearOrderRecordsResponseBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearOrderRecordsResponseBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearOrderRecordsResponseBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearOrderRecordsResponseBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearOrderRecordsResponseBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearOrderRecordsResponseBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearOrderRecordsResponseBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearOrderRecordsResponseBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearOrderRecordsResponseBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearOrderRecordsResponseBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearOrderRecordsResponseBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearOrderRecordsResponseBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearOrderRecordsResponseBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearOrderRecordsResponseBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearOrderRecordsResponseBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearOrderRecordsResponseBase::getResult() const
{
    return m_Result;
}


void LinearOrderRecordsResponseBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearOrderRecordsResponseBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearOrderRecordsResponseBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearOrderRecordsResponseBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearOrderRecordsResponseBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearOrderRecordsResponseBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearOrderRecordsResponseBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
