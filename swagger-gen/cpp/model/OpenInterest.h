...
#ifndef IO_SWAGGER_CLIENT_MODEL_OpenInterest_H_
#define IO_SWAGGER_CLIENT_MODEL_OpenInterest_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<OpenInterestInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<OpenInterestInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<OpenInterestInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_OpenInterest_H_ */
