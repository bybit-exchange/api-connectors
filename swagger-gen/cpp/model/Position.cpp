...
double Position::getRetCode() const
{
    return m_Ret_code;
}


void Position::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool Position::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void Position::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t Position::getRetMsg() const
{
    return m_Ret_msg;
}


void Position::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool Position::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void Position::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t Position::getExtCode() const
{
    return m_Ext_code;
}


void Position::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool Position::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void Position::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t Position::getExtInfo() const
{
    return m_Ext_info;
}


void Position::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool Position::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void Position::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> Position::getResult() const
{
    return m_Result;
}


void Position::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool Position::resultIsSet() const
{
    return m_ResultIsSet;
}

void Position::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t Position::getTimeNow() const
{
    return m_Time_now;
}


void Position::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool Position::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void Position::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
