...
void Symbols::validate()
{
    // TODO: implement validation
}

web::json::value Symbols::toJson() const
{
...
void Symbols::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<SymbolInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<SymbolInfo> newItem(new SymbolInfo());
...
void Symbols::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Symbols::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double Symbols::getRetCode() const
{
    return m_Ret_code;
}


void Symbols::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool Symbols::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void Symbols::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t Symbols::getRetMsg() const
{
    return m_Ret_msg;
}


void Symbols::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool Symbols::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void Symbols::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t Symbols::getExtCode() const
{
    return m_Ext_code;
}


void Symbols::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool Symbols::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void Symbols::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t Symbols::getExtInfo() const
{
    return m_Ext_info;
}


void Symbols::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool Symbols::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void Symbols::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<SymbolInfo>>& Symbols::getResult()
{
    return m_Result;
}

void Symbols::setResult(std::vector<std::shared_ptr<SymbolInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool Symbols::resultIsSet() const
{
    return m_ResultIsSet;
}

void Symbols::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t Symbols::getTimeNow() const
{
    return m_Time_now;
}


void Symbols::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool Symbols::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void Symbols::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
