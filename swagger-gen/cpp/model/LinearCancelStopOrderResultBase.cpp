...
#include "LinearCancelStopOrderResultBase.h"
...
void LinearCancelStopOrderResultBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearCancelStopOrderResultBase::toJson() const
{
...
void LinearCancelStopOrderResultBase::fromJson(web::json::value& val)
{
...
void LinearCancelStopOrderResultBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearCancelStopOrderResultBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearCancelStopOrderResultBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearCancelStopOrderResultBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearCancelStopOrderResultBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearCancelStopOrderResultBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearCancelStopOrderResultBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearCancelStopOrderResultBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearCancelStopOrderResultBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearCancelStopOrderResultBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearCancelStopOrderResultBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearCancelStopOrderResultBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearCancelStopOrderResultBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearCancelStopOrderResultBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearCancelStopOrderResultBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearCancelStopOrderResultBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearCancelStopOrderResultBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearCancelStopOrderResultBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearCancelStopOrderResultBase::getResult() const
{
    return m_Result;
}


void LinearCancelStopOrderResultBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearCancelStopOrderResultBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearCancelStopOrderResultBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearCancelStopOrderResultBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearCancelStopOrderResultBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearCancelStopOrderResultBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearCancelStopOrderResultBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
