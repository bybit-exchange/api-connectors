...
void LiqRecords::validate()
{
    // TODO: implement validation
}

web::json::value LiqRecords::toJson() const
{
...
void LiqRecords::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<LiqRecordsInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<LiqRecordsInfo> newItem(new LiqRecordsInfo());
...
void LiqRecords::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LiqRecords::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LiqRecords::getRetCode() const
{
    return m_Ret_code;
}


void LiqRecords::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LiqRecords::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LiqRecords::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LiqRecords::getRetMsg() const
{
    return m_Ret_msg;
}


void LiqRecords::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LiqRecords::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LiqRecords::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LiqRecords::getExtCode() const
{
    return m_Ext_code;
}


void LiqRecords::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LiqRecords::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LiqRecords::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LiqRecords::getExtInfo() const
{
    return m_Ext_info;
}


void LiqRecords::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LiqRecords::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LiqRecords::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<LiqRecordsInfo>>& LiqRecords::getResult()
{
    return m_Result;
}

void LiqRecords::setResult(std::vector<std::shared_ptr<LiqRecordsInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LiqRecords::resultIsSet() const
{
    return m_ResultIsSet;
}

void LiqRecords::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LiqRecords::getTimeNow() const
{
    return m_Time_now;
}


void LiqRecords::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LiqRecords::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LiqRecords::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
