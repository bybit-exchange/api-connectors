...
#include "LinearRiskLimitRespBase.h"
...
void LinearRiskLimitRespBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearRiskLimitRespBase::toJson() const
{
...
void LinearRiskLimitRespBase::fromJson(web::json::value& val)
{
...
void LinearRiskLimitRespBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearRiskLimitRespBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearRiskLimitRespBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearRiskLimitRespBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearRiskLimitRespBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearRiskLimitRespBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearRiskLimitRespBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearRiskLimitRespBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearRiskLimitRespBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearRiskLimitRespBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearRiskLimitRespBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearRiskLimitRespBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearRiskLimitRespBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearRiskLimitRespBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearRiskLimitRespBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearRiskLimitRespBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearRiskLimitRespBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearRiskLimitRespBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearRiskLimitRespBase::getResult() const
{
    return m_Result;
}


void LinearRiskLimitRespBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearRiskLimitRespBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearRiskLimitRespBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearRiskLimitRespBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearRiskLimitRespBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearRiskLimitRespBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearRiskLimitRespBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
