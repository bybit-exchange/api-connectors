...
#ifndef IO_SWAGGER_CLIENT_MODEL_SymbolInfoBase_H_
#define IO_SWAGGER_CLIENT_MODEL_SymbolInfoBase_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SymbolTickInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<SymbolTickInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<SymbolTickInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_SymbolInfoBase_H_ */
