...
#include "StopOrderOrdersResBase.h"
...
void StopOrderOrdersResBase::validate()
{
    // TODO: implement validation
}

web::json::value StopOrderOrdersResBase::toJson() const
{
...
void StopOrderOrdersResBase::fromJson(web::json::value& val)
{
...
void StopOrderOrdersResBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void StopOrderOrdersResBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double StopOrderOrdersResBase::getRetCode() const
{
    return m_Ret_code;
}


void StopOrderOrdersResBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool StopOrderOrdersResBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void StopOrderOrdersResBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t StopOrderOrdersResBase::getRetMsg() const
{
    return m_Ret_msg;
}


void StopOrderOrdersResBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool StopOrderOrdersResBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void StopOrderOrdersResBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t StopOrderOrdersResBase::getExtCode() const
{
    return m_Ext_code;
}


void StopOrderOrdersResBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool StopOrderOrdersResBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void StopOrderOrdersResBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t StopOrderOrdersResBase::getExtInfo() const
{
    return m_Ext_info;
}


void StopOrderOrdersResBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool StopOrderOrdersResBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void StopOrderOrdersResBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> StopOrderOrdersResBase::getResult() const
{
    return m_Result;
}


void StopOrderOrdersResBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool StopOrderOrdersResBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void StopOrderOrdersResBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t StopOrderOrdersResBase::getTimeNow() const
{
    return m_Time_now;
}


void StopOrderOrdersResBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool StopOrderOrdersResBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void StopOrderOrdersResBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
