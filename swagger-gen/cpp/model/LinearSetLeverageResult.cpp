...
#include "LinearSetLeverageResult.h"
...
void LinearSetLeverageResult::validate()
{
    // TODO: implement validation
}

web::json::value LinearSetLeverageResult::toJson() const
{
...
void LinearSetLeverageResult::fromJson(web::json::value& val)
{
...
void LinearSetLeverageResult::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearSetLeverageResult::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearSetLeverageResult::getRetCode() const
{
    return m_Ret_code;
}


void LinearSetLeverageResult::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearSetLeverageResult::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearSetLeverageResult::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearSetLeverageResult::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearSetLeverageResult::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearSetLeverageResult::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearSetLeverageResult::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearSetLeverageResult::getExtCode() const
{
    return m_Ext_code;
}


void LinearSetLeverageResult::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearSetLeverageResult::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearSetLeverageResult::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearSetLeverageResult::getExtInfo() const
{
    return m_Ext_info;
}


void LinearSetLeverageResult::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearSetLeverageResult::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearSetLeverageResult::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

utility::string_t LinearSetLeverageResult::getTimeNow() const
{
    return m_Time_now;
}


void LinearSetLeverageResult::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearSetLeverageResult::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearSetLeverageResult::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
