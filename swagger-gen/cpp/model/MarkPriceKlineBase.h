...
/*
 * MarkPriceKlineBase.h
 *
 * Get mark price kline information.
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_MarkPriceKlineBase_H_
#define IO_SWAGGER_CLIENT_MODEL_MarkPriceKlineBase_H_
...
/// Get mark price kline information.
/// </summary>
class  MarkPriceKlineBase
    : public ModelBase
{
public:
    MarkPriceKlineBase();
    virtual ~MarkPriceKlineBase();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<MarkPriceKlineInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<MarkPriceKlineInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<MarkPriceKlineInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_MarkPriceKlineBase_H_ */
