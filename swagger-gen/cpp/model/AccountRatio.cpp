...
void AccountRatio::validate()
{
    // TODO: implement validation
}

web::json::value AccountRatio::toJson() const
{
...
void AccountRatio::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<AccountRatioInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<AccountRatioInfo> newItem(new AccountRatioInfo());
...
void AccountRatio::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void AccountRatio::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double AccountRatio::getRetCode() const
{
    return m_Ret_code;
}


void AccountRatio::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool AccountRatio::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void AccountRatio::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t AccountRatio::getRetMsg() const
{
    return m_Ret_msg;
}


void AccountRatio::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool AccountRatio::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void AccountRatio::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t AccountRatio::getExtCode() const
{
    return m_Ext_code;
}


void AccountRatio::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool AccountRatio::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void AccountRatio::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t AccountRatio::getExtInfo() const
{
    return m_Ext_info;
}


void AccountRatio::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool AccountRatio::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void AccountRatio::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<AccountRatioInfo>>& AccountRatio::getResult()
{
    return m_Result;
}

void AccountRatio::setResult(std::vector<std::shared_ptr<AccountRatioInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool AccountRatio::resultIsSet() const
{
    return m_ResultIsSet;
}

void AccountRatio::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t AccountRatio::getTimeNow() const
{
    return m_Time_now;
}


void AccountRatio::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool AccountRatio::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void AccountRatio::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
