...
#ifndef IO_SWAGGER_CLIENT_MODEL_FundingRateBase_H_
#define IO_SWAGGER_CLIENT_MODEL_FundingRateBase_H_
...
/// Get the last funding Rate
/// </summary>
class  FundingRateBase
    : public ModelBase
{
public:
    FundingRateBase();
    virtual ~FundingRateBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_FundingRateBase_H_ */
