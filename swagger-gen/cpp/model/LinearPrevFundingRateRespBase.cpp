...
#include "LinearPrevFundingRateRespBase.h"
...
void LinearPrevFundingRateRespBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearPrevFundingRateRespBase::toJson() const
{
...
void LinearPrevFundingRateRespBase::fromJson(web::json::value& val)
{
...
void LinearPrevFundingRateRespBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearPrevFundingRateRespBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearPrevFundingRateRespBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearPrevFundingRateRespBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearPrevFundingRateRespBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearPrevFundingRateRespBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearPrevFundingRateRespBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearPrevFundingRateRespBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearPrevFundingRateRespBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearPrevFundingRateRespBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearPrevFundingRateRespBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearPrevFundingRateRespBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearPrevFundingRateRespBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearPrevFundingRateRespBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearPrevFundingRateRespBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearPrevFundingRateRespBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearPrevFundingRateRespBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearPrevFundingRateRespBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearPrevFundingRateRespBase::getResult() const
{
    return m_Result;
}


void LinearPrevFundingRateRespBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearPrevFundingRateRespBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearPrevFundingRateRespBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearPrevFundingRateRespBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearPrevFundingRateRespBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearPrevFundingRateRespBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearPrevFundingRateRespBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
