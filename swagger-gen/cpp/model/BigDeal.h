...
#ifndef IO_SWAGGER_CLIENT_MODEL_BigDeal_H_
#define IO_SWAGGER_CLIENT_MODEL_BigDeal_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BigDealInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<BigDealInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<BigDealInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_BigDeal_H_ */
