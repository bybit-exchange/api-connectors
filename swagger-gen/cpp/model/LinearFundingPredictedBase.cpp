...
#include "LinearFundingPredictedBase.h"
...
void LinearFundingPredictedBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearFundingPredictedBase::toJson() const
{
...
void LinearFundingPredictedBase::fromJson(web::json::value& val)
{
...
void LinearFundingPredictedBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearFundingPredictedBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearFundingPredictedBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearFundingPredictedBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearFundingPredictedBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearFundingPredictedBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearFundingPredictedBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearFundingPredictedBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearFundingPredictedBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearFundingPredictedBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearFundingPredictedBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearFundingPredictedBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearFundingPredictedBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearFundingPredictedBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearFundingPredictedBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearFundingPredictedBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearFundingPredictedBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearFundingPredictedBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearFundingPredictedBase::getResult() const
{
    return m_Result;
}


void LinearFundingPredictedBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearFundingPredictedBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearFundingPredictedBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearFundingPredictedBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearFundingPredictedBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearFundingPredictedBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearFundingPredictedBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
