...
#include "LinearCancelOrderResultBase.h"
...
void LinearCancelOrderResultBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearCancelOrderResultBase::toJson() const
{
...
void LinearCancelOrderResultBase::fromJson(web::json::value& val)
{
...
void LinearCancelOrderResultBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearCancelOrderResultBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearCancelOrderResultBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearCancelOrderResultBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearCancelOrderResultBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearCancelOrderResultBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearCancelOrderResultBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearCancelOrderResultBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearCancelOrderResultBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearCancelOrderResultBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearCancelOrderResultBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearCancelOrderResultBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearCancelOrderResultBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearCancelOrderResultBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearCancelOrderResultBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearCancelOrderResultBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearCancelOrderResultBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearCancelOrderResultBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearCancelOrderResultBase::getResult() const
{
    return m_Result;
}


void LinearCancelOrderResultBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearCancelOrderResultBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearCancelOrderResultBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearCancelOrderResultBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearCancelOrderResultBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearCancelOrderResultBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearCancelOrderResultBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
