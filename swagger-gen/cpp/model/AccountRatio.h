...
#ifndef IO_SWAGGER_CLIENT_MODEL_AccountRatio_H_
#define IO_SWAGGER_CLIENT_MODEL_AccountRatio_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AccountRatioInfo>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<AccountRatioInfo>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<AccountRatioInfo>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_AccountRatio_H_ */
