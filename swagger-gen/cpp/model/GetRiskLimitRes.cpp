...
void GetRiskLimitRes::validate()
{
    // TODO: implement validation
}

web::json::value GetRiskLimitRes::toJson() const
{
...
void GetRiskLimitRes::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<RiskIDRes>(nullptr) );
            }
            else
            {
                std::shared_ptr<RiskIDRes> newItem(new RiskIDRes());
...
void GetRiskLimitRes::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void GetRiskLimitRes::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double GetRiskLimitRes::getRetCode() const
{
    return m_Ret_code;
}


void GetRiskLimitRes::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool GetRiskLimitRes::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void GetRiskLimitRes::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t GetRiskLimitRes::getRetMsg() const
{
    return m_Ret_msg;
}


void GetRiskLimitRes::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool GetRiskLimitRes::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void GetRiskLimitRes::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t GetRiskLimitRes::getExtCode() const
{
    return m_Ext_code;
}


void GetRiskLimitRes::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool GetRiskLimitRes::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void GetRiskLimitRes::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t GetRiskLimitRes::getExtInfo() const
{
    return m_Ext_info;
}


void GetRiskLimitRes::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool GetRiskLimitRes::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void GetRiskLimitRes::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<RiskIDRes>>& GetRiskLimitRes::getResult()
{
    return m_Result;
}

void GetRiskLimitRes::setResult(std::vector<std::shared_ptr<RiskIDRes>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool GetRiskLimitRes::resultIsSet() const
{
    return m_ResultIsSet;
}

void GetRiskLimitRes::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t GetRiskLimitRes::getTimeNow() const
{
    return m_Time_now;
}


void GetRiskLimitRes::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool GetRiskLimitRes::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void GetRiskLimitRes::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
