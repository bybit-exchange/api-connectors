...
#ifndef IO_SWAGGER_CLIENT_MODEL_KlineBase_H_
#define IO_SWAGGER_CLIENT_MODEL_KlineBase_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<KlineRes>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<KlineRes>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<KlineRes>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_KlineBase_H_ */
