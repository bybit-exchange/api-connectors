...
#include "LinearPrevFundingRespBase.h"
...
void LinearPrevFundingRespBase::validate()
{
    // TODO: implement validation
}

web::json::value LinearPrevFundingRespBase::toJson() const
{
...
void LinearPrevFundingRespBase::fromJson(web::json::value& val)
{
...
void LinearPrevFundingRespBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LinearPrevFundingRespBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double LinearPrevFundingRespBase::getRetCode() const
{
    return m_Ret_code;
}


void LinearPrevFundingRespBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool LinearPrevFundingRespBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void LinearPrevFundingRespBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t LinearPrevFundingRespBase::getRetMsg() const
{
    return m_Ret_msg;
}


void LinearPrevFundingRespBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool LinearPrevFundingRespBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void LinearPrevFundingRespBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t LinearPrevFundingRespBase::getExtCode() const
{
    return m_Ext_code;
}


void LinearPrevFundingRespBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool LinearPrevFundingRespBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void LinearPrevFundingRespBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t LinearPrevFundingRespBase::getExtInfo() const
{
    return m_Ext_info;
}


void LinearPrevFundingRespBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool LinearPrevFundingRespBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void LinearPrevFundingRespBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> LinearPrevFundingRespBase::getResult() const
{
    return m_Result;
}


void LinearPrevFundingRespBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool LinearPrevFundingRespBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void LinearPrevFundingRespBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t LinearPrevFundingRespBase::getTimeNow() const
{
    return m_Time_now;
}


void LinearPrevFundingRespBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool LinearPrevFundingRespBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void LinearPrevFundingRespBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
