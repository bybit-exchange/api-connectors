...
void V2CancelOrderBase::validate()
{
    // TODO: implement validation
}

web::json::value V2CancelOrderBase::toJson() const
{
...
void V2CancelOrderBase::fromJson(web::json::value& val)
{
...
void V2CancelOrderBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void V2CancelOrderBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double V2CancelOrderBase::getRetCode() const
{
    return m_Ret_code;
}


void V2CancelOrderBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool V2CancelOrderBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void V2CancelOrderBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t V2CancelOrderBase::getRetMsg() const
{
    return m_Ret_msg;
}


void V2CancelOrderBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool V2CancelOrderBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void V2CancelOrderBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t V2CancelOrderBase::getExtCode() const
{
    return m_Ext_code;
}


void V2CancelOrderBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool V2CancelOrderBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void V2CancelOrderBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t V2CancelOrderBase::getExtInfo() const
{
    return m_Ext_info;
}


void V2CancelOrderBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool V2CancelOrderBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void V2CancelOrderBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::shared_ptr<Object> V2CancelOrderBase::getResult() const
{
    return m_Result;
}


void V2CancelOrderBase::setResult(std::shared_ptr<Object> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool V2CancelOrderBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void V2CancelOrderBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t V2CancelOrderBase::getTimeNow() const
{
    return m_Time_now;
}


void V2CancelOrderBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool V2CancelOrderBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void V2CancelOrderBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
