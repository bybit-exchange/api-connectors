...
#include "ExchangeOrderListBase.h"
...
void ExchangeOrderListBase::validate()
{
    // TODO: implement validation
}

web::json::value ExchangeOrderListBase::toJson() const
{
...
void ExchangeOrderListBase::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<ExchangeOrderList>(nullptr) );
            }
            else
            {
                std::shared_ptr<ExchangeOrderList> newItem(new ExchangeOrderList());
...
void ExchangeOrderListBase::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ExchangeOrderListBase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double ExchangeOrderListBase::getRetCode() const
{
    return m_Ret_code;
}


void ExchangeOrderListBase::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool ExchangeOrderListBase::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void ExchangeOrderListBase::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t ExchangeOrderListBase::getRetMsg() const
{
    return m_Ret_msg;
}


void ExchangeOrderListBase::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool ExchangeOrderListBase::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void ExchangeOrderListBase::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t ExchangeOrderListBase::getExtCode() const
{
    return m_Ext_code;
}


void ExchangeOrderListBase::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool ExchangeOrderListBase::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void ExchangeOrderListBase::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t ExchangeOrderListBase::getExtInfo() const
{
    return m_Ext_info;
}


void ExchangeOrderListBase::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool ExchangeOrderListBase::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void ExchangeOrderListBase::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<ExchangeOrderList>>& ExchangeOrderListBase::getResult()
{
    return m_Result;
}

void ExchangeOrderListBase::setResult(std::vector<std::shared_ptr<ExchangeOrderList>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool ExchangeOrderListBase::resultIsSet() const
{
    return m_ResultIsSet;
}

void ExchangeOrderListBase::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t ExchangeOrderListBase::getTimeNow() const
{
    return m_Time_now;
}


void ExchangeOrderListBase::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool ExchangeOrderListBase::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void ExchangeOrderListBase::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
