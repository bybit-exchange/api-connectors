...
/*
 * LinearPositionListResultBase.h
 *
 * Linear Positions Result Base
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_LinearPositionListResultBase_H_
#define IO_SWAGGER_CLIENT_MODEL_LinearPositionListResultBase_H_
...
/// Linear Positions Result Base
/// </summary>
class  LinearPositionListResultBase
    : public ModelBase
{
public:
    LinearPositionListResultBase();
    virtual ~LinearPositionListResultBase();
    ...
    /////////////////////////////////////////////
    /// LinearPositionListResultBase members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LinearPositionListResult>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<LinearPositionListResult>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<LinearPositionListResult>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_LinearPositionListResultBase_H_ */
