...
#ifndef IO_SWAGGER_CLIENT_MODEL_V2OrderListBase_H_
#define IO_SWAGGER_CLIENT_MODEL_V2OrderListBase_H_
...
/// Get order list response
/// </summary>
class  V2OrderListBase
    : public ModelBase
{
public:
    V2OrderListBase();
    virtual ~V2OrderListBase();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_V2OrderListBase_H_ */
