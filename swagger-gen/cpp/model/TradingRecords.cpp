...
void TradingRecords::validate()
{
    // TODO: implement validation
}

web::json::value TradingRecords::toJson() const
{
...
void TradingRecords::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[utility::conversions::to_string_t("result")].as_array() )
        {
            if(item.is_null())
            {
                m_Result.push_back( std::shared_ptr<TradingRecordsInfo>(nullptr) );
            }
            else
            {
                std::shared_ptr<TradingRecordsInfo> newItem(new TradingRecordsInfo());
...
void TradingRecords::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TradingRecords::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
double TradingRecords::getRetCode() const
{
    return m_Ret_code;
}


void TradingRecords::setRetCode(double value)
{
    m_Ret_code = value;
    m_Ret_codeIsSet = true;
}
bool TradingRecords::retCodeIsSet() const
{
    return m_Ret_codeIsSet;
}

void TradingRecords::unsetRet_code()
{
    m_Ret_codeIsSet = false;
}

utility::string_t TradingRecords::getRetMsg() const
{
    return m_Ret_msg;
}


void TradingRecords::setRetMsg(utility::string_t value)
{
    m_Ret_msg = value;
    m_Ret_msgIsSet = true;
}
bool TradingRecords::retMsgIsSet() const
{
    return m_Ret_msgIsSet;
}

void TradingRecords::unsetRet_msg()
{
    m_Ret_msgIsSet = false;
}

utility::string_t TradingRecords::getExtCode() const
{
    return m_Ext_code;
}


void TradingRecords::setExtCode(utility::string_t value)
{
    m_Ext_code = value;
    m_Ext_codeIsSet = true;
}
bool TradingRecords::extCodeIsSet() const
{
    return m_Ext_codeIsSet;
}

void TradingRecords::unsetExt_code()
{
    m_Ext_codeIsSet = false;
}

utility::string_t TradingRecords::getExtInfo() const
{
    return m_Ext_info;
}


void TradingRecords::setExtInfo(utility::string_t value)
{
    m_Ext_info = value;
    m_Ext_infoIsSet = true;
}
bool TradingRecords::extInfoIsSet() const
{
    return m_Ext_infoIsSet;
}

void TradingRecords::unsetExt_info()
{
    m_Ext_infoIsSet = false;
}

std::vector<std::shared_ptr<TradingRecordsInfo>>& TradingRecords::getResult()
{
    return m_Result;
}

void TradingRecords::setResult(std::vector<std::shared_ptr<TradingRecordsInfo>> value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
bool TradingRecords::resultIsSet() const
{
    return m_ResultIsSet;
}

void TradingRecords::unsetResult()
{
    m_ResultIsSet = false;
}

utility::string_t TradingRecords::getTimeNow() const
{
    return m_Time_now;
}


void TradingRecords::setTimeNow(utility::string_t value)
{
    m_Time_now = value;
    m_Time_nowIsSet = true;
}
bool TradingRecords::timeNowIsSet() const
{
    return m_Time_nowIsSet;
}

void TradingRecords::unsetTime_now()
{
    m_Time_nowIsSet = false;
}
