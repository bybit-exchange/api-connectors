...
/*
 * ExchangeOrderListBase.h
 *
 * Asset Exchange Records
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_ExchangeOrderListBase_H_
#define IO_SWAGGER_CLIENT_MODEL_ExchangeOrderListBase_H_
...
/// Asset Exchange Records
/// </summary>
class  ExchangeOrderListBase
    : public ModelBase
{
public:
    ExchangeOrderListBase();
    virtual ~ExchangeOrderListBase();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ExchangeOrderList>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<ExchangeOrderList>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<ExchangeOrderList>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_ExchangeOrderListBase_H_ */
