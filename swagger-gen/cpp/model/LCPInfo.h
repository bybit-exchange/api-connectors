...
#ifndef IO_SWAGGER_CLIENT_MODEL_LCPInfo_H_
#define IO_SWAGGER_CLIENT_MODEL_LCPInfo_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<LCPInfoBase> getResult() const;
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::shared_ptr<LCPInfoBase> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::shared_ptr<LCPInfoBase> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_LCPInfo_H_ */
