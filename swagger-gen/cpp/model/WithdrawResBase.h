...
#ifndef IO_SWAGGER_CLIENT_MODEL_WithdrawResBase_H_
#define IO_SWAGGER_CLIENT_MODEL_WithdrawResBase_H_
...
/// Get account withdraw records response
/// </summary>
class  WithdrawResBase
    : public ModelBase
{
public:
    WithdrawResBase();
    virtual ~WithdrawResBase();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WithdrawRecords>>& getResult();
    bool resultIsSet() const;
    void unsetResult();
    void setResult(std::vector<std::shared_ptr<WithdrawRecords>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<WithdrawRecords>> m_Result;
    bool m_ResultIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_WithdrawResBase_H_ */
