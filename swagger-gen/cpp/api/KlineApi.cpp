...
pplx::task<std::shared_ptr<Object>> KlineApi::kline_get(utility::string_t symbol, utility::string_t interval, double from, boost::optional<double> limit)
{
...
pplx::task<std::shared_ptr<Object>> KlineApi::kline_markPrice(utility::string_t symbol, utility::string_t interval, int32_t from, boost::optional<int32_t> limit)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/v2/public/mark-price-kline");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("KlineApi->kline_markPrice does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("KlineApi->kline_markPrice does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling kline_markPrice: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling kline_markPrice: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling kline_markPrice: unsupported response type"));
        }
