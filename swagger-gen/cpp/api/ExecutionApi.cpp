...
pplx::task<std::shared_ptr<Object>> ExecutionApi::execution_getTrades(boost::optional<utility::string_t> orderId, boost::optional<utility::string_t> symbol, boost::optional<utility::string_t> startTime, boost::optional<utility::string_t> page, boost::optional<utility::string_t> limit)
{
    ...
    utility::string_t path = utility::conversions::to_string_t("/v2/private/execution/list");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ExecutionApi->execution_getTrades does not produce any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling execution_getTrades: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling execution_getTrades: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling execution_getTrades: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Object>> ExecutionApi::positions_closePnlRecords(utility::string_t symbol, boost::optional<int32_t> startTime, boost::optional<int32_t> endTime, boost::optional<utility::string_t> execType, boost::optional<int32_t> page, boost::optional<int32_t> limit)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("ExecutionApi->positions_closePnlRecords does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("ExecutionApi->positions_closePnlRecords does not consume any supported media type"));
    }
