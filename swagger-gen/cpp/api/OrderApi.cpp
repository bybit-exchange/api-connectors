...
pplx::task<std::shared_ptr<Object>> OrderApi::order_cancel(utility::string_t symbol, boost::optional<utility::string_t> orderId, boost::optional<utility::string_t> orderLinkId)
{
...
pplx::task<std::shared_ptr<Object>> OrderApi::order_getOrders(utility::string_t symbol, boost::optional<double> limit, boost::optional<utility::string_t> orderStatus, boost::optional<utility::string_t> direction, boost::optional<utility::string_t> cursor)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/v2/private/order/list");
...
pplx::task<std::shared_ptr<Object>> OrderApi::order_replace(utility::string_t symbol, boost::optional<utility::string_t> orderId, boost::optional<utility::string_t> orderLinkId, boost::optional<utility::string_t> pRQty, boost::optional<utility::string_t> pRPrice)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/v2/private/order/replace");
