...
LinearExecutionApi::LinearExecutionApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Object>> LinearExecutionApi::linearExecution_getTrades(boost::optional<utility::string_t> symbol, boost::optional<int64_t> startTime, boost::optional<int64_t> endTime, boost::optional<utility::string_t> execType, boost::optional<int64_t> page, boost::optional<int64_t> limit)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/private/linear/trade/execution/list");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("LinearExecutionApi->linearExecution_getTrades does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("LinearExecutionApi->linearExecution_getTrades does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling linearExecution_getTrades: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling linearExecution_getTrades: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling linearExecution_getTrades: unsupported response type"));
        }
