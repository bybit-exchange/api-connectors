...
LinearMarketApi::LinearMarketApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Object>> LinearMarketApi::linearMarket_trading(utility::string_t symbol, boost::optional<utility::string_t> limit)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/public/linear/recent-trading-records");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("LinearMarketApi->linearMarket_trading does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("LinearMarketApi->linearMarket_trading does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling linearMarket_trading: ") + response.reason_phrase()
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling linearMarket_trading: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling linearMarket_trading: unsupported response type"));
        }
