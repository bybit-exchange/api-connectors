...
public class OrderCancelAllBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? orderCancelAllBase.retCode == null : this.retCode.equals(orderCancelAllBase.retCode)) &&
        (this.retMsg == null ? orderCancelAllBase.retMsg == null : this.retMsg.equals(orderCancelAllBase.retMsg)) &&
        (this.extCode == null ? orderCancelAllBase.extCode == null : this.extCode.equals(orderCancelAllBase.extCode)) &&
        (this.extInfo == null ? orderCancelAllBase.extInfo == null : this.extInfo.equals(orderCancelAllBase.extInfo)) &&
        (this.result == null ? orderCancelAllBase.result == null : this.result.equals(orderCancelAllBase.result)) &&
        (this.timeNow == null ? orderCancelAllBase.timeNow == null : this.timeNow.equals(orderCancelAllBase.timeNow));
  }
