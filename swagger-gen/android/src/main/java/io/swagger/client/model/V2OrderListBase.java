...
public class V2OrderListBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? v2OrderListBase.retCode == null : this.retCode.equals(v2OrderListBase.retCode)) &&
        (this.retMsg == null ? v2OrderListBase.retMsg == null : this.retMsg.equals(v2OrderListBase.retMsg)) &&
        (this.extCode == null ? v2OrderListBase.extCode == null : this.extCode.equals(v2OrderListBase.extCode)) &&
        (this.extInfo == null ? v2OrderListBase.extInfo == null : this.extInfo.equals(v2OrderListBase.extInfo)) &&
        (this.result == null ? v2OrderListBase.result == null : this.result.equals(v2OrderListBase.result)) &&
        (this.timeNow == null ? v2OrderListBase.timeNow == null : this.timeNow.equals(v2OrderListBase.timeNow));
  }
