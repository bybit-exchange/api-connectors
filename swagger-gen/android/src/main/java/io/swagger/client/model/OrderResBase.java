...
public class OrderResBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? orderResBase.retCode == null : this.retCode.equals(orderResBase.retCode)) &&
        (this.retMsg == null ? orderResBase.retMsg == null : this.retMsg.equals(orderResBase.retMsg)) &&
        (this.extCode == null ? orderResBase.extCode == null : this.extCode.equals(orderResBase.extCode)) &&
        (this.extInfo == null ? orderResBase.extInfo == null : this.extInfo.equals(orderResBase.extInfo)) &&
        (this.result == null ? orderResBase.result == null : this.result.equals(orderResBase.result)) &&
        (this.timeNow == null ? orderResBase.timeNow == null : this.timeNow.equals(orderResBase.timeNow));
  }
