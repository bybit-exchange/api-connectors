...
public class WalletBalanceBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? walletBalanceBase.retCode == null : this.retCode.equals(walletBalanceBase.retCode)) &&
        (this.retMsg == null ? walletBalanceBase.retMsg == null : this.retMsg.equals(walletBalanceBase.retMsg)) &&
        (this.extCode == null ? walletBalanceBase.extCode == null : this.extCode.equals(walletBalanceBase.extCode)) &&
        (this.extInfo == null ? walletBalanceBase.extInfo == null : this.extInfo.equals(walletBalanceBase.extInfo)) &&
        (this.result == null ? walletBalanceBase.result == null : this.result.equals(walletBalanceBase.result)) &&
        (this.timeNow == null ? walletBalanceBase.timeNow == null : this.timeNow.equals(walletBalanceBase.timeNow));
  }
