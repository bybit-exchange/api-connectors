...
public class SetRiskLimitBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? setRiskLimitBase.retCode == null : this.retCode.equals(setRiskLimitBase.retCode)) &&
        (this.retMsg == null ? setRiskLimitBase.retMsg == null : this.retMsg.equals(setRiskLimitBase.retMsg)) &&
        (this.extCode == null ? setRiskLimitBase.extCode == null : this.extCode.equals(setRiskLimitBase.extCode)) &&
        (this.extInfo == null ? setRiskLimitBase.extInfo == null : this.extInfo.equals(setRiskLimitBase.extInfo)) &&
        (this.result == null ? setRiskLimitBase.result == null : this.result.equals(setRiskLimitBase.result)) &&
        (this.timeNow == null ? setRiskLimitBase.timeNow == null : this.timeNow.equals(setRiskLimitBase.timeNow));
  }
