...
public class V2CancelOrderBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? v2CancelOrderBase.retCode == null : this.retCode.equals(v2CancelOrderBase.retCode)) &&
        (this.retMsg == null ? v2CancelOrderBase.retMsg == null : this.retMsg.equals(v2CancelOrderBase.retMsg)) &&
        (this.extCode == null ? v2CancelOrderBase.extCode == null : this.extCode.equals(v2CancelOrderBase.extCode)) &&
        (this.extInfo == null ? v2CancelOrderBase.extInfo == null : this.extInfo.equals(v2CancelOrderBase.extInfo)) &&
        (this.result == null ? v2CancelOrderBase.result == null : this.result.equals(v2CancelOrderBase.result)) &&
        (this.timeNow == null ? v2CancelOrderBase.timeNow == null : this.timeNow.equals(v2CancelOrderBase.timeNow));
  }
