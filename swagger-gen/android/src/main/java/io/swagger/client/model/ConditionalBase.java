...
public class ConditionalBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? conditionalBase.retCode == null : this.retCode.equals(conditionalBase.retCode)) &&
        (this.retMsg == null ? conditionalBase.retMsg == null : this.retMsg.equals(conditionalBase.retMsg)) &&
        (this.extCode == null ? conditionalBase.extCode == null : this.extCode.equals(conditionalBase.extCode)) &&
        (this.extInfo == null ? conditionalBase.extInfo == null : this.extInfo.equals(conditionalBase.extInfo)) &&
        (this.result == null ? conditionalBase.result == null : this.result.equals(conditionalBase.result)) &&
        (this.timeNow == null ? conditionalBase.timeNow == null : this.timeNow.equals(conditionalBase.timeNow));
  }
