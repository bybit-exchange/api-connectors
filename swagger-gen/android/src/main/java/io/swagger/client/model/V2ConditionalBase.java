...
public class V2ConditionalBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? v2ConditionalBase.retCode == null : this.retCode.equals(v2ConditionalBase.retCode)) &&
        (this.retMsg == null ? v2ConditionalBase.retMsg == null : this.retMsg.equals(v2ConditionalBase.retMsg)) &&
        (this.extCode == null ? v2ConditionalBase.extCode == null : this.extCode.equals(v2ConditionalBase.extCode)) &&
        (this.extInfo == null ? v2ConditionalBase.extInfo == null : this.extInfo.equals(v2ConditionalBase.extInfo)) &&
        (this.result == null ? v2ConditionalBase.result == null : this.result.equals(v2ConditionalBase.result)) &&
        (this.timeNow == null ? v2ConditionalBase.timeNow == null : this.timeNow.equals(v2ConditionalBase.timeNow));
  }
