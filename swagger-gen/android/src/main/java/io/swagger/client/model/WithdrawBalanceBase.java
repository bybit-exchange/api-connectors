...
public class WithdrawBalanceBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? withdrawBalanceBase.retCode == null : this.retCode.equals(withdrawBalanceBase.retCode)) &&
        (this.retMsg == null ? withdrawBalanceBase.retMsg == null : this.retMsg.equals(withdrawBalanceBase.retMsg)) &&
        (this.extCode == null ? withdrawBalanceBase.extCode == null : this.extCode.equals(withdrawBalanceBase.extCode)) &&
        (this.extInfo == null ? withdrawBalanceBase.extInfo == null : this.extInfo.equals(withdrawBalanceBase.extInfo)) &&
        (this.result == null ? withdrawBalanceBase.result == null : this.result.equals(withdrawBalanceBase.result)) &&
        (this.timeNow == null ? withdrawBalanceBase.timeNow == null : this.timeNow.equals(withdrawBalanceBase.timeNow));
  }
