...
public class RiskLimitBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? riskLimitBase.retCode == null : this.retCode.equals(riskLimitBase.retCode)) &&
        (this.retMsg == null ? riskLimitBase.retMsg == null : this.retMsg.equals(riskLimitBase.retMsg)) &&
        (this.extCode == null ? riskLimitBase.extCode == null : this.extCode.equals(riskLimitBase.extCode)) &&
        (this.extInfo == null ? riskLimitBase.extInfo == null : this.extInfo.equals(riskLimitBase.extInfo)) &&
        (this.result == null ? riskLimitBase.result == null : this.result.equals(riskLimitBase.result)) &&
        (this.timeNow == null ? riskLimitBase.timeNow == null : this.timeNow.equals(riskLimitBase.timeNow));
  }
