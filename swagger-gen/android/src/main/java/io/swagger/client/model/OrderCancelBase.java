...
public class OrderCancelBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? orderCancelBase.retCode == null : this.retCode.equals(orderCancelBase.retCode)) &&
        (this.retMsg == null ? orderCancelBase.retMsg == null : this.retMsg.equals(orderCancelBase.retMsg)) &&
        (this.extCode == null ? orderCancelBase.extCode == null : this.extCode.equals(orderCancelBase.extCode)) &&
        (this.extInfo == null ? orderCancelBase.extInfo == null : this.extInfo.equals(orderCancelBase.extInfo)) &&
        (this.result == null ? orderCancelBase.result == null : this.result.equals(orderCancelBase.result)) &&
        (this.timeNow == null ? orderCancelBase.timeNow == null : this.timeNow.equals(orderCancelBase.timeNow));
  }
