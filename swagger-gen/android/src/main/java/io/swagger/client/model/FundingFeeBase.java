...
public class FundingFeeBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? fundingFeeBase.retCode == null : this.retCode.equals(fundingFeeBase.retCode)) &&
        (this.retMsg == null ? fundingFeeBase.retMsg == null : this.retMsg.equals(fundingFeeBase.retMsg)) &&
        (this.extCode == null ? fundingFeeBase.extCode == null : this.extCode.equals(fundingFeeBase.extCode)) &&
        (this.extInfo == null ? fundingFeeBase.extInfo == null : this.extInfo.equals(fundingFeeBase.extInfo)) &&
        (this.result == null ? fundingFeeBase.result == null : this.result.equals(fundingFeeBase.result)) &&
        (this.timeNow == null ? fundingFeeBase.timeNow == null : this.timeNow.equals(fundingFeeBase.timeNow));
  }
