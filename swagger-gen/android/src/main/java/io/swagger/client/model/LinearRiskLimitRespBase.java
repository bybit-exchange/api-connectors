...
public class LinearRiskLimitRespBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? linearRiskLimitRespBase.retCode == null : this.retCode.equals(linearRiskLimitRespBase.retCode)) &&
        (this.retMsg == null ? linearRiskLimitRespBase.retMsg == null : this.retMsg.equals(linearRiskLimitRespBase.retMsg)) &&
        (this.extCode == null ? linearRiskLimitRespBase.extCode == null : this.extCode.equals(linearRiskLimitRespBase.extCode)) &&
        (this.extInfo == null ? linearRiskLimitRespBase.extInfo == null : this.extInfo.equals(linearRiskLimitRespBase.extInfo)) &&
        (this.result == null ? linearRiskLimitRespBase.result == null : this.result.equals(linearRiskLimitRespBase.result)) &&
        (this.timeNow == null ? linearRiskLimitRespBase.timeNow == null : this.timeNow.equals(linearRiskLimitRespBase.timeNow));
  }
