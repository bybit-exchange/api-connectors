...
public class TradeRecordsBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? tradeRecordsBase.retCode == null : this.retCode.equals(tradeRecordsBase.retCode)) &&
        (this.retMsg == null ? tradeRecordsBase.retMsg == null : this.retMsg.equals(tradeRecordsBase.retMsg)) &&
        (this.extCode == null ? tradeRecordsBase.extCode == null : this.extCode.equals(tradeRecordsBase.extCode)) &&
        (this.extInfo == null ? tradeRecordsBase.extInfo == null : this.extInfo.equals(tradeRecordsBase.extInfo)) &&
        (this.result == null ? tradeRecordsBase.result == null : this.result.equals(tradeRecordsBase.result)) &&
        (this.timeNow == null ? tradeRecordsBase.timeNow == null : this.timeNow.equals(tradeRecordsBase.timeNow));
  }
