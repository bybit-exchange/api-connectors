...
public class StopOrderOrdersResBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? stopOrderOrdersResBase.retCode == null : this.retCode.equals(stopOrderOrdersResBase.retCode)) &&
        (this.retMsg == null ? stopOrderOrdersResBase.retMsg == null : this.retMsg.equals(stopOrderOrdersResBase.retMsg)) &&
        (this.extCode == null ? stopOrderOrdersResBase.extCode == null : this.extCode.equals(stopOrderOrdersResBase.extCode)) &&
        (this.extInfo == null ? stopOrderOrdersResBase.extInfo == null : this.extInfo.equals(stopOrderOrdersResBase.extInfo)) &&
        (this.result == null ? stopOrderOrdersResBase.result == null : this.result.equals(stopOrderOrdersResBase.result)) &&
        (this.timeNow == null ? stopOrderOrdersResBase.timeNow == null : this.timeNow.equals(stopOrderOrdersResBase.timeNow));
  }
