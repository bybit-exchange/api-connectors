...
public class FundRecordBase {
  ...
  public boolean equals(Object o) {
    ...
    return (this.retCode == null ? fundRecordBase.retCode == null : this.retCode.equals(fundRecordBase.retCode)) &&
        (this.retMsg == null ? fundRecordBase.retMsg == null : this.retMsg.equals(fundRecordBase.retMsg)) &&
        (this.extCode == null ? fundRecordBase.extCode == null : this.extCode.equals(fundRecordBase.extCode)) &&
        (this.extInfo == null ? fundRecordBase.extInfo == null : this.extInfo.equals(fundRecordBase.extInfo)) &&
        (this.result == null ? fundRecordBase.result == null : this.result.equals(fundRecordBase.result)) &&
        (this.timeNow == null ? fundRecordBase.timeNow == null : this.timeNow.equals(fundRecordBase.timeNow));
  }
