...
public class WalletApi {
  ...
  * 
   ...
   * @param from Start ID. By default, returns the latest IDs
   * @param direction Search direction. Prev: searches in ascending order from start ID, Next: searches in descending order from start ID. Defaults to Next
   * @return Object
  */
  public Object walletExchangeOrder (BigDecimal limit, BigDecimal from, String direction) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/v2/private/exchange-order/list";
   ...
   * Asset Exchange Records
   * 
   * @param limit Limit for data size per page, max size is 50. Default as showing 20 pieces of data per page   * @param from Start ID. By default, returns the latest IDs   * @param direction Search direction. Prev: searches in ascending order from start ID, Next: searches in descending order from start ID. Defaults to Next
  */
  public void walletExchangeOrder (BigDecimal limit, BigDecimal from, String direction, final Response.Listener<Object> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;


    // create path and map variables
    String path = "/v2/private/exchange-order/list".replaceAll("\\{format\\}","json");
