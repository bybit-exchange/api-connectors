...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearFundingPredictedBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearFundingPredictedBase model module.
   * @module model/LinearFundingPredictedBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearFundingPredictedBase</code>.
   * Get Predicted Funding
   * @alias module:model/LinearFundingPredictedBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearFundingPredictedBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearFundingPredictedBase} obj Optional instance to populate.
   * @return {module:model/LinearFundingPredictedBase} The populated <code>LinearFundingPredictedBase</code> instance.
   */
