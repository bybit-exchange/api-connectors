...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FundingRecords'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FundingRecords'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.FundRecordBase = factory(root.BybitApi.ApiClient, root.BybitApi.FundingRecords);
  }
}(this, function(ApiClient, FundingRecords) {
  'use strict';
  ...
  /**
   * The FundRecordBase model module.
   * @module model/FundRecordBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FundRecordBase</code>.
   * Get funding record response
   * @alias module:model/FundRecordBase
   * @class
   */
  ...
  /**
   * Constructs a <code>FundRecordBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundRecordBase} obj Optional instance to populate.
   * @return {module:model/FundRecordBase} The populated <code>FundRecordBase</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [FundingRecords]);
      }
  ...
  /**
   * @member {Array.<module:model/FundingRecords>} result
   */
