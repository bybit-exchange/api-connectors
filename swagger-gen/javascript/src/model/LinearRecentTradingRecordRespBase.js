...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearRecentTradingRecordRespBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearRecentTradingRecordRespBase model module.
   * @module model/LinearRecentTradingRecordRespBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearRecentTradingRecordRespBase</code>.
   * Get Recent Trading Record
   * @alias module:model/LinearRecentTradingRecordRespBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearRecentTradingRecordRespBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearRecentTradingRecordRespBase} obj Optional instance to populate.
   * @return {module:model/LinearRecentTradingRecordRespBase} The populated <code>LinearRecentTradingRecordRespBase</code> instance.
   */
