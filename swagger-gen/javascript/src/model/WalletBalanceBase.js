...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.WalletBalanceBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The WalletBalanceBase model module.
   * @module model/WalletBalanceBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>WalletBalanceBase</code>.
   * Get account withdraw balance response
   * @alias module:model/WalletBalanceBase
   * @class
   */
  ...
  /**
   * Constructs a <code>WalletBalanceBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WalletBalanceBase} obj Optional instance to populate.
   * @return {module:model/WalletBalanceBase} The populated <code>WalletBalanceBase</code> instance.
   */
