...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClosedPnlInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ClosedPnlInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.ClosedPnlBase = factory(root.BybitApi.ApiClient, root.BybitApi.ClosedPnlInfo);
  }
}(this, function(ApiClient, ClosedPnlInfo) {
  'use strict';
  ...
  /**
   * The ClosedPnlBase model module.
   * @module model/ClosedPnlBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>ClosedPnlBase</code>.
   * Get the closed-pnl/list response
   * @alias module:model/ClosedPnlBase
   * @class
   */
  ...
  /**
   * Constructs a <code>ClosedPnlBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClosedPnlBase} obj Optional instance to populate.
   * @return {module:model/ClosedPnlBase} The populated <code>ClosedPnlBase</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [ClosedPnlInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/ClosedPnlInfo>} result
   */
