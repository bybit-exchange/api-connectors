...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.QueryOrderRes = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The QueryOrderRes model module.
   * @module model/QueryOrderRes
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>QueryOrderRes</code>.
   * Query real-time active order information response
   * @alias module:model/QueryOrderRes
   * @class
   */
  ...
  /**
   * Constructs a <code>QueryOrderRes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/QueryOrderRes} obj Optional instance to populate.
   * @return {module:model/QueryOrderRes} The populated <code>QueryOrderRes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ext_fields')) {
        obj['ext_fields'] = ApiClient.convertToType(data['ext_fields'], Object);
      }
  ...
  /**
   * @member {Object} ext_fields
   */
  exports.prototype['ext_fields'] = undefined;
  /**
