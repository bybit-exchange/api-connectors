...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearOrderRecordsResponseBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearOrderRecordsResponseBase model module.
   * @module model/LinearOrderRecordsResponseBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearOrderRecordsResponseBase</code>.
   * Linear Order list Base
   * @alias module:model/LinearOrderRecordsResponseBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearOrderRecordsResponseBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearOrderRecordsResponseBase} obj Optional instance to populate.
   * @return {module:model/LinearOrderRecordsResponseBase} The populated <code>LinearOrderRecordsResponseBase</code> instance.
   */
