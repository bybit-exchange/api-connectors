...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearOrderCancelAllBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearOrderCancelAllBase model module.
   * @module model/LinearOrderCancelAllBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearOrderCancelAllBase</code>.
   * Cancel all linear active orders response
   * @alias module:model/LinearOrderCancelAllBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearOrderCancelAllBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearOrderCancelAllBase} obj Optional instance to populate.
   * @return {module:model/LinearOrderCancelAllBase} The populated <code>LinearOrderCancelAllBase</code> instance.
   */
