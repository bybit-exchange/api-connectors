...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearSearchStopOrderResultBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearSearchStopOrderResultBase model module.
   * @module model/LinearSearchStopOrderResultBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearSearchStopOrderResultBase</code>.
   * Linear Order Query Result Base
   * @alias module:model/LinearSearchStopOrderResultBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearSearchStopOrderResultBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearSearchStopOrderResultBase} obj Optional instance to populate.
   * @return {module:model/LinearSearchStopOrderResultBase} The populated <code>LinearSearchStopOrderResultBase</code> instance.
   */
