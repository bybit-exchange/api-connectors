...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearStopOrderCancelAllBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearStopOrderCancelAllBase model module.
   * @module model/LinearStopOrderCancelAllBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearStopOrderCancelAllBase</code>.
   * Cancel all linear stop orders response
   * @alias module:model/LinearStopOrderCancelAllBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearStopOrderCancelAllBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearStopOrderCancelAllBase} obj Optional instance to populate.
   * @return {module:model/LinearStopOrderCancelAllBase} The populated <code>LinearStopOrderCancelAllBase</code> instance.
   */
