...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.Leverage = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The Leverage model module.
   * @module model/Leverage
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>Leverage</code>.
   * Get user leverage.
   * @alias module:model/Leverage
   * @class
   */
  ...
  /**
   * Constructs a <code>Leverage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Leverage} obj Optional instance to populate.
   * @return {module:model/Leverage} The populated <code>Leverage</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rate_limit_status')) {
        obj['rate_limit_status'] = ApiClient.convertToType(data['rate_limit_status'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Number} rate_limit_status
   */
  exports.prototype['rate_limit_status'] = undefined;
