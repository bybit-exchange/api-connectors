...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearSearchOrderResultBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearSearchOrderResultBase model module.
   * @module model/LinearSearchOrderResultBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearSearchOrderResultBase</code>.
   * Linear Order Query Result Base
   * @alias module:model/LinearSearchOrderResultBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearSearchOrderResultBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearSearchOrderResultBase} obj Optional instance to populate.
   * @return {module:model/LinearSearchOrderResultBase} The populated <code>LinearSearchOrderResultBase</code> instance.
   */
