...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.OrderCancelBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The OrderCancelBase model module.
   * @module model/OrderCancelBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrderCancelBase</code>.
   * cancel order response
   * @alias module:model/OrderCancelBase
   * @class
   */
  ...
  /**
   * Constructs a <code>OrderCancelBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderCancelBase} obj Optional instance to populate.
   * @return {module:model/OrderCancelBase} The populated <code>OrderCancelBase</code> instance.
   */
