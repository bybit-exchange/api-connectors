...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearStopOrderRecordsResponseBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearStopOrderRecordsResponseBase model module.
   * @module model/LinearStopOrderRecordsResponseBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearStopOrderRecordsResponseBase</code>.
   * Linear Stop Order list Base
   * @alias module:model/LinearStopOrderRecordsResponseBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearStopOrderRecordsResponseBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearStopOrderRecordsResponseBase} obj Optional instance to populate.
   * @return {module:model/LinearStopOrderRecordsResponseBase} The populated <code>LinearStopOrderRecordsResponseBase</code> instance.
   */
