...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OderBookRes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OderBookRes'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.OrderBookBase = factory(root.BybitApi.ApiClient, root.BybitApi.OderBookRes);
  }
}(this, function(ApiClient, OderBookRes) {
  'use strict';
  ...
  /**
   * The OrderBookBase model module.
   * @module model/OrderBookBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrderBookBase</code>.
   * Get the orderbook response
   * @alias module:model/OrderBookBase
   * @class
   */
  ...
  /**
   * Constructs a <code>OrderBookBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderBookBase} obj Optional instance to populate.
   * @return {module:model/OrderBookBase} The populated <code>OrderBookBase</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [OderBookRes]);
      }
  ...
  /**
   * @member {Array.<module:model/OderBookRes>} result
   */
