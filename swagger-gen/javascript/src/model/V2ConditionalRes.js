...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.V2ConditionalRes = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The V2ConditionalRes model module.
   * @module model/V2ConditionalRes
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>V2ConditionalRes</code>.
   * Place new conditional order response
   * @alias module:model/V2ConditionalRes
   * @class
   */
  ...
  /**
   * Constructs a <code>V2ConditionalRes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2ConditionalRes} obj Optional instance to populate.
   * @return {module:model/V2ConditionalRes} The populated <code>V2ConditionalRes</code> instance.
   */
