...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.ConditionalBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The ConditionalBase model module.
   * @module model/ConditionalBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConditionalBase</code>.
   * Place new conditional order response
   * @alias module:model/ConditionalBase
   * @class
   */
  ...
  /**
   * Constructs a <code>ConditionalBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConditionalBase} obj Optional instance to populate.
   * @return {module:model/ConditionalBase} The populated <code>ConditionalBase</code> instance.
   */
