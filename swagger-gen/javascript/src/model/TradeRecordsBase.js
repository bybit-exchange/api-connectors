...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TradeRecords'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TradeRecords'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.TradeRecordsBase = factory(root.BybitApi.ApiClient, root.BybitApi.TradeRecords);
  }
}(this, function(ApiClient, TradeRecords) {
  'use strict';
  ...
  /**
   * The TradeRecordsBase model module.
   * @module model/TradeRecordsBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>TradeRecordsBase</code>.
   * Get the trade records of a order response
   * @alias module:model/TradeRecordsBase
   * @class
   */
  ...
  /**
   * Constructs a <code>TradeRecordsBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TradeRecordsBase} obj Optional instance to populate.
   * @return {module:model/TradeRecordsBase} The populated <code>TradeRecordsBase</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [TradeRecords]);
      }
  ...
  /**
   * @member {Array.<module:model/TradeRecords>} result
   */
