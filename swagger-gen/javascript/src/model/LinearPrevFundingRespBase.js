...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearPrevFundingRespBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearPrevFundingRespBase model module.
   * @module model/LinearPrevFundingRespBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearPrevFundingRespBase</code>.
   * Get My Last Funding
   * @alias module:model/LinearPrevFundingRespBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearPrevFundingRespBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearPrevFundingRespBase} obj Optional instance to populate.
   * @return {module:model/LinearPrevFundingRespBase} The populated <code>LinearPrevFundingRespBase</code> instance.
   */
