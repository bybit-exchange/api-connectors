...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.SetRiskLimitBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The SetRiskLimitBase model module.
   * @module model/SetRiskLimitBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SetRiskLimitBase</code>.
   * Set risk limit.
   * @alias module:model/SetRiskLimitBase
   * @class
   */
  ...
  /**
   * Constructs a <code>SetRiskLimitBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SetRiskLimitBase} obj Optional instance to populate.
   * @return {module:model/SetRiskLimitBase} The populated <code>SetRiskLimitBase</code> instance.
   */
