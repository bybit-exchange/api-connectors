...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearPrevFundingRateRespBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearPrevFundingRateRespBase model module.
   * @module model/LinearPrevFundingRateRespBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearPrevFundingRateRespBase</code>.
   * Get Prev Funding Rate
   * @alias module:model/LinearPrevFundingRateRespBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearPrevFundingRateRespBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearPrevFundingRateRespBase} obj Optional instance to populate.
   * @return {module:model/LinearPrevFundingRateRespBase} The populated <code>LinearPrevFundingRateRespBase</code> instance.
   */
