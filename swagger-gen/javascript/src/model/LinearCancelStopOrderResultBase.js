...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearCancelStopOrderResultBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearCancelStopOrderResultBase model module.
   * @module model/LinearCancelStopOrderResultBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearCancelStopOrderResultBase</code>.
   * Cancel Linear Stop Order Base
   * @alias module:model/LinearCancelStopOrderResultBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearCancelStopOrderResultBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearCancelStopOrderResultBase} obj Optional instance to populate.
   * @return {module:model/LinearCancelStopOrderResultBase} The populated <code>LinearCancelStopOrderResultBase</code> instance.
   */
