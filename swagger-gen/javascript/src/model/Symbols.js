...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SymbolInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SymbolInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.Symbols = factory(root.BybitApi.ApiClient, root.BybitApi.SymbolInfo);
  }
}(this, function(ApiClient, SymbolInfo) {
  'use strict';
  ...
  /**
   * The Symbols model module.
   * @module model/Symbols
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Symbols</code>.
   * Get symbol information.
   * @alias module:model/Symbols
   * @class
   */
  ...
  /**
   * Constructs a <code>Symbols</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Symbols} obj Optional instance to populate.
   * @return {module:model/Symbols} The populated <code>Symbols</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [SymbolInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/SymbolInfo>} result
   */
