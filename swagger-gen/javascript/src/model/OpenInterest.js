...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OpenInterestInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OpenInterestInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.OpenInterest = factory(root.BybitApi.ApiClient, root.BybitApi.OpenInterestInfo);
  }
}(this, function(ApiClient, OpenInterestInfo) {
  'use strict';
  ...
  /**
   * The OpenInterest model module.
   * @module model/OpenInterest
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>OpenInterest</code>.
   * Get open_interest information.
   * @alias module:model/OpenInterest
   * @class
   */
  ...
  /**
   * Constructs a <code>OpenInterest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OpenInterest} obj Optional instance to populate.
   * @return {module:model/OpenInterest} The populated <code>OpenInterest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [OpenInterestInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/OpenInterestInfo>} result
   */
