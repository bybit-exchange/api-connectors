...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearSwitchIsolatedResult = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearSwitchIsolatedResult model module.
   * @module model/LinearSwitchIsolatedResult
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearSwitchIsolatedResult</code>.
   * Switch isolated result
   * @alias module:model/LinearSwitchIsolatedResult
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearSwitchIsolatedResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearSwitchIsolatedResult} obj Optional instance to populate.
   * @return {module:model/LinearSwitchIsolatedResult} The populated <code>LinearSwitchIsolatedResult</code> instance.
   */
