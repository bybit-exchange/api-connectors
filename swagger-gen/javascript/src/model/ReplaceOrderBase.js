...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.ReplaceOrderBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The ReplaceOrderBase model module.
   * @module model/ReplaceOrderBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReplaceOrderBase</code>.
   * Replace active order response
   * @alias module:model/ReplaceOrderBase
   * @class
   */
  ...
  /**
   * Constructs a <code>ReplaceOrderBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReplaceOrderBase} obj Optional instance to populate.
   * @return {module:model/ReplaceOrderBase} The populated <code>ReplaceOrderBase</code> instance.
   */
