...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SymbolTickInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SymbolTickInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.SymbolInfoBase = factory(root.BybitApi.ApiClient, root.BybitApi.SymbolTickInfo);
  }
}(this, function(ApiClient, SymbolTickInfo) {
  'use strict';
  ...
  /**
   * The SymbolInfoBase model module.
   * @module model/SymbolInfoBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>SymbolInfoBase</code>.
   * Get the orderbook response
   * @alias module:model/SymbolInfoBase
   * @class
   */
  ...
  /**
   * Constructs a <code>SymbolInfoBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SymbolInfoBase} obj Optional instance to populate.
   * @return {module:model/SymbolInfoBase} The populated <code>SymbolInfoBase</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [SymbolTickInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/SymbolTickInfo>} result
   */
