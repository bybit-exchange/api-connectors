...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/KlineRes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./KlineRes'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.KlineBase = factory(root.BybitApi.ApiClient, root.BybitApi.KlineRes);
  }
}(this, function(ApiClient, KlineRes) {
  'use strict';
  ...
  /**
   * The KlineBase model module.
   * @module model/KlineBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>KlineBase</code>.
   * Get the orderbook response
   * @alias module:model/KlineBase
   * @class
   */
  ...
  /**
   * Constructs a <code>KlineBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KlineBase} obj Optional instance to populate.
   * @return {module:model/KlineBase} The populated <code>KlineBase</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [KlineRes]);
      }
  ...
  /**
   * @member {Array.<module:model/KlineRes>} result
   */
