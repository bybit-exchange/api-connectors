...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.TradingStopBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The TradingStopBase model module.
   * @module model/TradingStopBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TradingStopBase</code>.
   * Set Trading-Stop Condition response
   * @alias module:model/TradingStopBase
   * @class
   */
  ...
  /**
   * Constructs a <code>TradingStopBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TradingStopBase} obj Optional instance to populate.
   * @return {module:model/TradingStopBase} The populated <code>TradingStopBase</code> instance.
   */
