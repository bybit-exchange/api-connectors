...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.QueryOrderBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The QueryOrderBase model module.
   * @module model/QueryOrderBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>QueryOrderBase</code>.
   * Query real-time active order information response
   * @alias module:model/QueryOrderBase
   * @class
   */
  ...
  /**
   * Constructs a <code>QueryOrderBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/QueryOrderBase} obj Optional instance to populate.
   * @return {module:model/QueryOrderBase} The populated <code>QueryOrderBase</code> instance.
   */
