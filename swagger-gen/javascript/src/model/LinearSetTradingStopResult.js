...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearSetTradingStopResult = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearSetTradingStopResult model module.
   * @module model/LinearSetTradingStopResult
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearSetTradingStopResult</code>.
   * Set Trading Stop result
   * @alias module:model/LinearSetTradingStopResult
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearSetTradingStopResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearSetTradingStopResult} obj Optional instance to populate.
   * @return {module:model/LinearSetTradingStopResult} The populated <code>LinearSetTradingStopResult</code> instance.
   */
