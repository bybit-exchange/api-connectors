...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.V2OrderListBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The V2OrderListBase model module.
   * @module model/V2OrderListBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>V2OrderListBase</code>.
   * Get order list response
   * @alias module:model/V2OrderListBase
   * @class
   */
  ...
  /**
   * Constructs a <code>V2OrderListBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2OrderListBase} obj Optional instance to populate.
   * @return {module:model/V2OrderListBase} The populated <code>V2OrderListBase</code> instance.
   */
