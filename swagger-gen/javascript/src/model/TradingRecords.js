...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TradingRecordsInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TradingRecordsInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.TradingRecords = factory(root.BybitApi.ApiClient, root.BybitApi.TradingRecordsInfo);
  }
}(this, function(ApiClient, TradingRecordsInfo) {
  'use strict';
  ...
  /**
   * The TradingRecords model module.
   * @module model/TradingRecords
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>TradingRecords</code>.
   * Get the Trading Records response
   * @alias module:model/TradingRecords
   * @class
   */
  ...
  /**
   * Constructs a <code>TradingRecords</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TradingRecords} obj Optional instance to populate.
   * @return {module:model/TradingRecords} The populated <code>TradingRecords</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [TradingRecordsInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/TradingRecordsInfo>} result
   */
