...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearStopOrderReplace = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearStopOrderReplace model module.
   * @module model/LinearStopOrderReplace
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearStopOrderReplace</code>.
   * replace conditional order can modify/amend your conditional orders
   * @alias module:model/LinearStopOrderReplace
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearStopOrderReplace</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearStopOrderReplace} obj Optional instance to populate.
   * @return {module:model/LinearStopOrderReplace} The populated <code>LinearStopOrderReplace</code> instance.
   */
