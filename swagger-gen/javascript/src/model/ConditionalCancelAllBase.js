...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.ConditionalCancelAllBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The ConditionalCancelAllBase model module.
   * @module model/ConditionalCancelAllBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ConditionalCancelAllBase</code>.
   * Cancel all conditional order response
   * @alias module:model/ConditionalCancelAllBase
   * @class
   */
  ...
  /**
   * Constructs a <code>ConditionalCancelAllBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConditionalCancelAllBase} obj Optional instance to populate.
   * @return {module:model/ConditionalCancelAllBase} The populated <code>ConditionalCancelAllBase</code> instance.
   */
