...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LiqRecordsInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LiqRecordsInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.LiqRecords = factory(root.BybitApi.ApiClient, root.BybitApi.LiqRecordsInfo);
  }
}(this, function(ApiClient, LiqRecordsInfo) {
  'use strict';
  ...
  /**
   * The LiqRecords model module.
   * @module model/LiqRecords
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LiqRecords</code>.
   * Get liq_records information.
   * @alias module:model/LiqRecords
   * @class
   */
  ...
  /**
   * Constructs a <code>LiqRecords</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LiqRecords} obj Optional instance to populate.
   * @return {module:model/LiqRecords} The populated <code>LiqRecords</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [LiqRecordsInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/LiqRecordsInfo>} result
   */
