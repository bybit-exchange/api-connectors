...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearSetMarginResultBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearSetMarginResultBase model module.
   * @module model/LinearSetMarginResultBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearSetMarginResultBase</code>.
   * Set auto add margin result
   * @alias module:model/LinearSetMarginResultBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearSetMarginResultBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearSetMarginResultBase} obj Optional instance to populate.
   * @return {module:model/LinearSetMarginResultBase} The populated <code>LinearSetMarginResultBase</code> instance.
   */
