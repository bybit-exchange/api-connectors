...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.OrderResBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The OrderResBase model module.
   * @module model/OrderResBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>OrderResBase</code>.
   * Place new order response
   * @alias module:model/OrderResBase
   * @class
   */
  ...
  /**
   * Constructs a <code>OrderResBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderResBase} obj Optional instance to populate.
   * @return {module:model/OrderResBase} The populated <code>OrderResBase</code> instance.
   */
