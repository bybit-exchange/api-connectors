...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountRatioInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountRatioInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.AccountRatio = factory(root.BybitApi.ApiClient, root.BybitApi.AccountRatioInfo);
  }
}(this, function(ApiClient, AccountRatioInfo) {
  'use strict';
  ...
  /**
   * The AccountRatio model module.
   * @module model/AccountRatio
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>AccountRatio</code>.
   * Get account long short account ratio information.
   * @alias module:model/AccountRatio
   * @class
   */
  ...
  /**
   * Constructs a <code>AccountRatio</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountRatio} obj Optional instance to populate.
   * @return {module:model/AccountRatio} The populated <code>AccountRatio</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [AccountRatioInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/AccountRatioInfo>} result
   */
