...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RiskIDRes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RiskIDRes'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.GetRiskLimitRes = factory(root.BybitApi.ApiClient, root.BybitApi.RiskIDRes);
  }
}(this, function(ApiClient, RiskIDRes) {
  'use strict';
  ...
  /**
   * The GetRiskLimitRes model module.
   * @module model/GetRiskLimitRes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetRiskLimitRes</code>.
   * Get risk limit.
   * @alias module:model/GetRiskLimitRes
   * @class
   */
  ...
  /**
   * Constructs a <code>GetRiskLimitRes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetRiskLimitRes} obj Optional instance to populate.
   * @return {module:model/GetRiskLimitRes} The populated <code>GetRiskLimitRes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [RiskIDRes]);
      }
  ...
  /**
   * @member {Array.<module:model/RiskIDRes>} result
   */
