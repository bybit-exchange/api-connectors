...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BigDealInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BigDealInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.BigDeal = factory(root.BybitApi.ApiClient, root.BybitApi.BigDealInfo);
  }
}(this, function(ApiClient, BigDealInfo) {
  'use strict';
  ...
  /**
   * The BigDeal model module.
   * @module model/BigDeal
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>BigDeal</code>.
   * Get big deal information.
   * @alias module:model/BigDeal
   * @class
   */
  ...
  /**
   * Constructs a <code>BigDeal</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BigDeal} obj Optional instance to populate.
   * @return {module:model/BigDeal} The populated <code>BigDeal</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [BigDealInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/BigDealInfo>} result
   */
