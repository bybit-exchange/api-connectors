...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearOrderReplace = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearOrderReplace model module.
   * @module model/LinearOrderReplace
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearOrderReplace</code>.
   * replace order can modify/amend your active orders
   * @alias module:model/LinearOrderReplace
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearOrderReplace</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearOrderReplace} obj Optional instance to populate.
   * @return {module:model/LinearOrderReplace} The populated <code>LinearOrderReplace</code> instance.
   */
