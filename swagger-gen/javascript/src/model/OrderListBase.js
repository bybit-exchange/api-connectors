...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.OrderListBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The OrderListBase model module.
   * @module model/OrderListBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrderListBase</code>.
   * Get order list response
   * @alias module:model/OrderListBase
   * @class
   */
  ...
  /**
   * Constructs a <code>OrderListBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderListBase} obj Optional instance to populate.
   * @return {module:model/OrderListBase} The populated <code>OrderListBase</code> instance.
   */
