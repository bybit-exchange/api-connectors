...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearRiskLimitRespBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearRiskLimitRespBase model module.
   * @module model/LinearRiskLimitRespBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearRiskLimitRespBase</code>.
   * Get Risk Limit
   * @alias module:model/LinearRiskLimitRespBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearRiskLimitRespBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearRiskLimitRespBase} obj Optional instance to populate.
   * @return {module:model/LinearRiskLimitRespBase} The populated <code>LinearRiskLimitRespBase</code> instance.
   */
