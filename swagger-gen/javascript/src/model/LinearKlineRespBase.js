...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearKlineRespBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearKlineRespBase model module.
   * @module model/LinearKlineRespBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearKlineRespBase</code>.
   * Get Kline
   * @alias module:model/LinearKlineRespBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearKlineRespBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearKlineRespBase} obj Optional instance to populate.
   * @return {module:model/LinearKlineRespBase} The populated <code>LinearKlineRespBase</code> instance.
   */
