...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.FundingFeeBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The FundingFeeBase model module.
   * @module model/FundingFeeBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>FundingFeeBase</code>.
   * Get the last funding fee
   * @alias module:model/FundingFeeBase
   * @class
   */
  ...
  /**
   * Constructs a <code>FundingFeeBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingFeeBase} obj Optional instance to populate.
   * @return {module:model/FundingFeeBase} The populated <code>FundingFeeBase</code> instance.
   */
