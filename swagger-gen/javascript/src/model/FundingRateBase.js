...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.FundingRateBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The FundingRateBase model module.
   * @module model/FundingRateBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>FundingRateBase</code>.
   * Get the last funding Rate
   * @alias module:model/FundingRateBase
   * @class
   */
  ...
  /**
   * Constructs a <code>FundingRateBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingRateBase} obj Optional instance to populate.
   * @return {module:model/FundingRateBase} The populated <code>FundingRateBase</code> instance.
   */
