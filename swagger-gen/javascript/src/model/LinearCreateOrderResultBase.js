...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearCreateOrderResultBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearCreateOrderResultBase model module.
   * @module model/LinearCreateOrderResultBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearCreateOrderResultBase</code>.
   * Create Linear Order Base
   * @alias module:model/LinearCreateOrderResultBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearCreateOrderResultBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearCreateOrderResultBase} obj Optional instance to populate.
   * @return {module:model/LinearCreateOrderResultBase} The populated <code>LinearCreateOrderResultBase</code> instance.
   */
