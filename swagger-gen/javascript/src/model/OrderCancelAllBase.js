...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.OrderCancelAllBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The OrderCancelAllBase model module.
   * @module model/OrderCancelAllBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>OrderCancelAllBase</code>.
   * Cancel all active orders response
   * @alias module:model/OrderCancelAllBase
   * @class
   */
  ...
  /**
   * Constructs a <code>OrderCancelAllBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrderCancelAllBase} obj Optional instance to populate.
   * @return {module:model/OrderCancelAllBase} The populated <code>OrderCancelAllBase</code> instance.
   */
