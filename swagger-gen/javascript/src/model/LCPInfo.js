...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LCPInfoBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LCPInfoBase'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.LCPInfo = factory(root.BybitApi.ApiClient, root.BybitApi.LCPInfoBase);
  }
}(this, function(ApiClient, LCPInfoBase) {
  'use strict';
  ...
  /**
   * The LCPInfo model module.
   * @module model/LCPInfo
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LCPInfo</code>.
   * Query LCP info.
   * @alias module:model/LCPInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>LCPInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LCPInfo} obj Optional instance to populate.
   * @return {module:model/LCPInfo} The populated <code>LCPInfo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = LCPInfoBase.constructFromObject(data['result']);
      }
  ...
  /**
   * @member {module:model/LCPInfoBase} result
   */
