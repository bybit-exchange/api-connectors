...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.RiskLimitBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The RiskLimitBase model module.
   * @module model/RiskLimitBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>RiskLimitBase</code>.
   * Get risk limit.
   * @alias module:model/RiskLimitBase
   * @class
   */
  ...
  /**
   * Constructs a <code>RiskLimitBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskLimitBase} obj Optional instance to populate.
   * @return {module:model/RiskLimitBase} The populated <code>RiskLimitBase</code> instance.
   */
