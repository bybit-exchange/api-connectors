...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearCancelOrderResultBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearCancelOrderResultBase model module.
   * @module model/LinearCancelOrderResultBase
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearCancelOrderResultBase</code>.
   * Create Linear Order Base
   * @alias module:model/LinearCancelOrderResultBase
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearCancelOrderResultBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearCancelOrderResultBase} obj Optional instance to populate.
   * @return {module:model/LinearCancelOrderResultBase} The populated <code>LinearCancelOrderResultBase</code> instance.
   */
