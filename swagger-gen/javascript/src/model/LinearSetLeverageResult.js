...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.LinearSetLeverageResult = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The LinearSetLeverageResult model module.
   * @module model/LinearSetLeverageResult
   * @version 0.2.10
   */

  /**
   * Constructs a new <code>LinearSetLeverageResult</code>.
   * Set leverage result
   * @alias module:model/LinearSetLeverageResult
   * @class
   */
  ...
  /**
   * Constructs a <code>LinearSetLeverageResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinearSetLeverageResult} obj Optional instance to populate.
   * @return {module:model/LinearSetLeverageResult} The populated <code>LinearSetLeverageResult</code> instance.
   */
