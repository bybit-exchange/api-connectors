...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.FundingPredictedBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The FundingPredictedBase model module.
   * @module model/FundingPredictedBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FundingPredictedBase</code>.
   * Get the last funding fee
   * @alias module:model/FundingPredictedBase
   * @class
   */
  ...
  /**
   * Constructs a <code>FundingPredictedBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FundingPredictedBase} obj Optional instance to populate.
   * @return {module:model/FundingPredictedBase} The populated <code>FundingPredictedBase</code> instance.
   */
