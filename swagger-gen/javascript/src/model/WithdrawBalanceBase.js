...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BybitApi.WithdrawBalanceBase = factory(root.BybitApi.ApiClient);
  }
  ...
  /**
   * The WithdrawBalanceBase model module.
   * @module model/WithdrawBalanceBase
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>WithdrawBalanceBase</code>.
   * Get account withdraw balance response
   * @alias module:model/WithdrawBalanceBase
   * @class
   */
  ...
  /**
   * Constructs a <code>WithdrawBalanceBase</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WithdrawBalanceBase} obj Optional instance to populate.
   * @return {module:model/WithdrawBalanceBase} The populated <code>WithdrawBalanceBase</code> instance.
   */
