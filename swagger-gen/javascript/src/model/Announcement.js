...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AnnouncementInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AnnouncementInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.BybitApi) {
      root.BybitApi = {};
    }
    root.BybitApi.Announcement = factory(root.BybitApi.ApiClient, root.BybitApi.AnnouncementInfo);
  }
}(this, function(ApiClient, AnnouncementInfo) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) {
        obj['result'] = ApiClient.convertToType(data['result'], [AnnouncementInfo]);
      }
  ...
  /**
   * @member {Array.<module:model/AnnouncementInfo>} result
   */
