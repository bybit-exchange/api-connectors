...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.ConditionalBase();
  });
  ...
  describe('ConditionalBase', function() {
    it('should create an instance of ConditionalBase', function() {
      // uncomment below and update the code to test ConditionalBase
      //var instance = new BybitApi.ConditionalBase();
      //expect(instance).to.be.a(BybitApi.ConditionalBase);
    });
