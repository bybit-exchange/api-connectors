...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BybitApi.WithdrawBalanceBase();
  });
  ...
  describe('WithdrawBalanceBase', function() {
    it('should create an instance of WithdrawBalanceBase', function() {
      // uncomment below and update the code to test WithdrawBalanceBase
      //var instance = new BybitApi.WithdrawBalanceBase();
      //expect(instance).to.be.a(BybitApi.WithdrawBalanceBase);
    });
