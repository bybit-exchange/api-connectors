# Swagger\Client\LinearFundingApi
...
$apiInstance = new Swagger\Client\Api\LinearFundingApi(
...
try {
    $result = $apiInstance->linearFundingMyLastFee($symbol);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LinearFundingApi->linearFundingMyLastFee: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $result = $apiInstance->linearFundingPredicted($symbol);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LinearFundingApi->linearFundingPredicted: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $result = $apiInstance->linearFundingPrevRate($symbol);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LinearFundingApi->linearFundingPrevRate: ', $e->getMessage(), PHP_EOL;
}
?>
```
