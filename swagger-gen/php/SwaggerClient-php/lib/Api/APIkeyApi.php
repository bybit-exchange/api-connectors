...
class APIkeyApi
{
    ...
    {
        list($response) = $this->aPIkeyInfoWithHttpInfo();
        return $response;
    }
     ...
     */
    public function aPIkeyInfoWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->aPIkeyInfoRequest();
     ...
     */
    public function aPIkeyInfoAsync()
    {
        return $this->aPIkeyInfoAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function aPIkeyInfoAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->aPIkeyInfoRequest();
     ...
     */
    protected function aPIkeyInfoRequest()
    {

        $resourcePath = '/open-api/api-key';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
