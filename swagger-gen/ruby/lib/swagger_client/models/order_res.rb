...
module SwaggerClient
  ...
  class OrderRes
    ...
    attr_accessor :cum_exec_value

    attr_accessor :cum_exec_fee
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'last_exec_time')
        self.last_exec_time = attributes[:'last_exec_time']
      end

      if attributes.has_key?(:'last_exec_price')
      ...
      if attributes.has_key?(:'cum_exec_value')
        self.cum_exec_value = attributes[:'cum_exec_value']
      end

      if attributes.has_key?(:'cum_exec_fee')
        self.cum_exec_fee = attributes[:'cum_exec_fee']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_exec_time == o.last_exec_time &&
          last_exec_price == o.last_exec_price &&
          leaves_qty == o.leaves_qty &&
          cum_exec_qty == o.cum_exec_qty &&
          cum_exec_value == o.cum_exec_value &&
          cum_exec_fee == o.cum_exec_fee &&
    ...
    def hash
      [order_id, user_id, symbol, side, order_type, price, qty, time_in_force, order_status, last_exec_time, last_exec_price, leaves_qty, cum_exec_qty, cum_exec_value, cum_exec_fee, reject_reason, order_link_id, created_at, updated_at].hash
    end
