...
module SwaggerClient
  ...
  class FundingFeeRes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'exec_timestamp')
        self.exec_timestamp = attributes[:'exec_timestamp']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exec_fee == o.exec_fee &&
          exec_timestamp == o.exec_timestamp
    end
    ...
    def hash
      [symbol, side, size, funding_rate, exec_fee, exec_timestamp].hash
    end
