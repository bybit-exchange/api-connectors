...
module SwaggerClient
  ...
  class WithdrawRecords
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'submited_at')
        self.submited_at = attributes[:'submited_at']
      end
    ...
    def hash
      [id, user_id, coin, status, amount, fee, address, tx_id, submited_at, updated_at].hash
    end
