...
module SwaggerClient
  ...
  class ConditionalCancelAllRes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cancel_type')
      ...
      if attributes.has_key?(:'trigger_by')
        self.trigger_by = attributes[:'trigger_by']
      end
    ...
    def hash
      [cl_ord_id, user_id, symbol, side, order_type, price, qty, time_in_force, create_type, cancel_type, order_status, leaves_qty, leaves_value, cross_seq, stop_order_type, trigger_by, created_at, updated_at].hash
    end
