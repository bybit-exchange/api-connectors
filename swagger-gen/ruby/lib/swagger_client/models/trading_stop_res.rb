...
module SwaggerClient
  ...
  class TradingStopRes
    ...
    def hash
      [id, user_id, symbol, side, size, position_value, entry_price, risk_id, auto_add_margin, leverage, position_margin, liq_price, bust_price, occ_closing_fee, occ_funding_fee, take_profit, stop_loss, trailing_stop, position_status, deleverage_indicator, oc_calc_data, order_margin, wallet_balance, realised_pnl, cum_realised_pnl, cum_commission, cross_seq, position_seq, created_at, updated_at].hash
    end
