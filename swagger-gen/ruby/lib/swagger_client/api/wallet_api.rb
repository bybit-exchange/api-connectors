...
module SwaggerClient
  class WalletApi
    ...
    # @return [Object]
    def wallet_exchange_order(opts = {})
      data, _status_code, _headers = wallet_exchange_order_with_http_info(opts)
      data
    end
    ...
    def wallet_exchange_order_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WalletApi.wallet_exchange_order ...'
      end
      # resource path
      local_var_path = '/v2/private/exchange-order/list'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Object')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WalletApi#wallet_exchange_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
