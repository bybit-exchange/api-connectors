...
if __name__ == "__main__":
    ...
    while(1):
        ...
        # logger.info(ws.get_instrument_info_data("100ms", "BTCUSD"))
        # logger.info(ws.get_trade_data("BTCUSD"))
        # logger.info(ws.get_order_data())
        # logger.info(ws.get_stoporder_data())
        # logger.info(ws.get_execution_data())
        # logger.info(ws.get_position_data())
        # logger.info(ws.get_insurance_BTC_data())
        # logger.info(ws.get_insurance_ETH_data())
        # logger.info(ws.get_insurance_EOS_data())
        # logger.info(ws.get_insurance_XRP_data())
        # logger.info(ws.get_wallet_data())
        sleep(1)
